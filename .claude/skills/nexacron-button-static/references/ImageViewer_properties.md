...
| `accessibilityaction` | ImageViewer에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 a |
| `accessibilitydesclevel` | ImageViewer 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | ImageViewer에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 d |
| `accessibilityenable` | ImageViewer 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | ImageViewer에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 l |
...
**Syntax**
```javascript
ImageViewer.set_border(strborder) // set
ImageViewer.border // get
```
...
**Syntax**
```javascript
ImageViewer.set_edge(stredge) // set
ImageViewer.edge // get
```
...
**Syntax**
```javascript
ImageViewer.set_padding(strpadding) // set
ImageViewer.padding // get
```

**Setting Syntax**
```javascript
ImageViewer 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
ImageViewer.set_accessibilityaction(strAction) // set
ImageViewer.accessibilityaction // get
```
...
**Syntax**
```javascript
ImageViewer.set_accessibilitydesclevel(enumLevel) // set
ImageViewer.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
ImageViewer 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
ImageViewer.set_accessibilitydescription(strDescription) // set
ImageViewer.accessibilitydescription // get
```
...
**Syntax**
```javascript
ImageViewer.set_accessibilityenable(bEnable) // set
ImageViewer.accessibilityenable // get
```

**Setting Syntax**
```javascript
ImageViewer 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
ImageViewer.set_accessibilitylabel(strLabel) // set
ImageViewer.accessibilitylabel // get
```
...
**Syntax**
```javascript
ImageViewer.set_accessibilityrole(enumRole) // set
ImageViewer.accessibilityrole // get
```
...
**Syntax**
```javascript
ImageViewer.set_background( strBackground ) // set 
ImageViewer.background // get
```
...
**Syntax**
```javascript
ImageViewer.set_borderRadius(strborderradius) // set
ImageViewer.borderRadius // get
```
...
**Syntax**
```javascript
ImageViewer.set_bottom(nBottom) // set
ImageViewer.bottom // get
```

**Setting Syntax**
```javascript
ImageViewer 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 ImageViewer 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 ImageViewer 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 ImageViewer 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 ImageViewer 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
ImageViewer.set_boxShadow(strbshadow) // set
ImageViewer.boxShadow // get
```
...
**Syntax**
```javascript
ImageViewer.set_color(strcolor) // set
ImageViewer.color // get
```
...
**Syntax**
```javascript
ImageViewer.set_cssclass(strcssclass) // set
ImageViewer.cssclass // get
```
...
**Syntax**
```javascript
ImageViewer.set_cursor(strCursor) // set
ImageViewer.cursor // get
```
...
**Syntax**
```javascript
ImageViewer.set_enable(benable) // set
ImageViewer.enable // get
```

**Setting Syntax**
```javascript
ImageViewer 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
ImageViewer.set_enableevent(bEvent) // set
ImageViewer.enableevent // get
```

**Setting Syntax**
```javascript
ImageViewer 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
ImageViewer.set_expr(strExpr) // set
ImageViewer.expr // get
```
...
**Remark**
- 동적으로 ImageViewer 에 적용된 텍스트는 getDisplayText() 메소드를 사용하여 확인할 수 있습니다.
...
**Syntax**
```javascript
ImageViewer.set_fittocontents(enumFitTo) // set
ImageViewer.fittocontents // get
```

**Setting Syntax**
```javascript
컨텐츠 내용에 맞게 ImageViewer 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.
```
...
**Syntax**
```javascript
ImageViewer.set_flexgrow(fVal) // set
ImageViewer.flexgrow // get
```
...
**Syntax**
```javascript
ImageViewer.set_flexshrink(fVal) // set
ImageViewer.flexshrink // get
```
...
**Syntax**
```javascript
ImageViewer.set_font(strfont) // set
ImageViewer.font // get
```
...
**Syntax**
```javascript
ImageViewer.set_height(nHeight) // set
ImageViewer.height // get
```

**Setting Syntax**
```javascript
ImageViewer 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 ImageViewer 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 ImageViewer 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
ImageViewer.set_hotkey(strHotkey) // set
ImageViewer.hotkey // get
```
...
**Setting Syntax**
```javascript
ImageViewer를 구별할 수 있는 유일값을 갖습니다.
```
...
**Syntax**
```javascript
ImageViewer.set_image(strImage) // set
ImageViewer.image // get
```
...
**Syntax**
```javascript
ImageViewer.set_imagealign(strAlign) // set
ImageViewer.imagealign // get
```

**Setting Syntax**
```javascript
이미지가 표시될 세로 위치를 설정합니다.
...
**Syntax**
```javascript
ImageViewer.set_initvalueid(strValueID) // set
ImageViewer.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 ImageViewer 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
ImageViewer.set_layoutorder(nVal) // set
ImageViewer.layoutorder // get
```
...
**Syntax**
```javascript
ImageViewer.set_left(nLeft) // set
ImageViewer.left // get
```

**Setting Syntax**
```javascript
ImageViewer 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 ImageViewer 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 ImageViewer 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 ImageViewer 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 ImageViewer 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
ImageViewer.set_letterSpacing(strspace) // set
ImageViewer.letterSpacing // get
```
...
**Syntax**
```javascript
ImageViewer.set_maxheight(nMaxHeight) // set
ImageViewer.maxheight // get
```

**Setting Syntax**
```javascript
ImageViewer 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ImageViewer.set_maxwidth(nMaxWidth) // set
ImageViewer.maxwidth // get
```

**Setting Syntax**
```javascript
ImageViewer 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ImageViewer.set_minheight(nMinHeight) // set
ImageViewer.minheight // get
```

**Setting Syntax**
```javascript
ImageViewer 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ImageViewer.set_minwidth(nMinWidth) // set
ImageViewer.minwidth // get
```

**Setting Syntax**
```javascript
ImageViewer 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ImageViewer.set_name(strName) // set
ImageViewer.name // get
```
...
**Syntax**
```javascript
ImageViewer.set_opacity(strOpacity) // set
ImageViewer.opacity // get
```
...
**Syntax**
```javascript
ImageViewer.set_positionstep(nStep) // set
ImageViewer.positionstep // get
```

**Setting Syntax**
```javascript
ImageViewer 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
ImageViewer.set_right(nRight) // set
ImageViewer.right // get
```

**Setting Syntax**
```javascript
ImageViewer 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 ImageViewer 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 ImageViewer 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 ImageViewer 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 ImageViewer 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
ImageViewer 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
ImageViewer.set_stretch(enumStretch) // set
ImageViewer.stretch // get
```

**Setting Syntax**
```javascript
이미지의 가로/세로 비율을 유지하며 ImageViewer 에 전체 이미지를 표시합니다.
...
**Syntax**
```javascript
ImageViewer.set_tablecellarea(strArea) // set
ImageViewer.tablecellarea // get
```
...
**Syntax**
```javascript
ImageViewer.set_taborder(nTabOrder) // set
ImageViewer.taborder // get
```
...
**Syntax**
```javascript
ImageViewer.set_tabstop(bTabStop) // set
ImageViewer.tabstop // get
```

**Setting Syntax**
```javascript
ImageViewer 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
ImageViewer.set_text(strText) // set
ImageViewer.text // get
```

**Setting Syntax**
```javascript
ImageViewer 에 표시될 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
ImageViewer.set_tooltiptext(strToolTipText) // set
ImageViewer.tooltiptext // get
```
...
**Syntax**
```javascript
ImageViewer.set_tooltiptype(enumTooltipType) // set
ImageViewer.tooltiptype // get
```

**Setting Syntax**
```javascript
ImageViewer 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
ImageViewer.set_top(nTop) // set
ImageViewer.top // get
```

**Setting Syntax**
```javascript
ImageViewer 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 ImageViewer 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 ImageViewer 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 ImageViewer 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 ImageViewer 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
ImageViewer.set_visible(bVisible) // set
ImageViewer.visible // get
```

**Setting Syntax**
```javascript
ImageViewer 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
ImageViewer.set_width(nWidth) // set
ImageViewer.width // get
```

**Setting Syntax**
```javascript
ImageViewer 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 ImageViewer 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 ImageViewer 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
ImageViewer.set_wordSpacing(strWordSpacing) // set
ImageViewer.wordSpacing // get
```
