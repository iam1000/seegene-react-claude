...
| `accessibilityaction` | ProgressBar에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 a |
| `accessibilitydesclevel` | ProgressBar 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | ProgressBar에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 d |
| `accessibilityenable` | ProgressBar 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | ProgressBar에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 l |
...
**Syntax**
```javascript
ProgressBar.set_border(strborder) // set
ProgressBar.border // get
```
...
**Syntax**
```javascript
ProgressBar.set_edge(stredge) // set
ProgressBar.edge // get
```
...
**Syntax**
```javascript
ProgressBar.set_padding(strpadding) // set
ProgressBar.padding // get
```

**Setting Syntax**
```javascript
ProgressBar 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
ProgressBar.set_accessibilityaction(strAction) // set
ProgressBar.accessibilityaction // get
```
...
**Syntax**
```javascript
ProgressBar.set_accessibilitydesclevel(enumLevel) // set
ProgressBar.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
ProgressBar 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
ProgressBar.set_accessibilitydescription(strDescription) // set
ProgressBar.accessibilitydescription // get
```
...
**Syntax**
```javascript
ProgressBar.set_accessibilityenable(bEnable) // set
ProgressBar.accessibilityenable // get
```

**Setting Syntax**
```javascript
ProgressBar 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
ProgressBar.set_accessibilitylabel(strLabel) // set
ProgressBar.accessibilitylabel // get
```
...
**Syntax**
```javascript
ProgressBar.set_accessibilityrole(enumRole) // set
ProgressBar.accessibilityrole // get
```
...
**Syntax**
```javascript
ProgressBar.set_background( strBackground ) // set 
ProgressBar.background // get
```
...
**Syntax**
```javascript
ProgressBar.set_blockgap(nGap) // set
ProgressBar.blockgap // get
```
...
**Syntax**
```javascript
ProgressBar.set_blocksize(nWidth) // set
ProgressBar.blocksize // get
```
...
**Syntax**
```javascript
ProgressBar.set_borderRadius(strborderradius) // set
ProgressBar.borderRadius // get
```
...
**Syntax**
```javascript
ProgressBar.set_bottom(nBottom) // set
ProgressBar.bottom // get
```

**Setting Syntax**
```javascript
ProgressBar 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 ProgressBar 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 ProgressBar 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 ProgressBar 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 ProgressBar 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
ProgressBar.set_boxShadow(strbshadow) // set
ProgressBar.boxShadow // get
```
...
**Syntax**
```javascript
ProgressBar.set_color(strcolor) // set
ProgressBar.color // get
```
...
**Syntax**
```javascript
ProgressBar.set_cssclass(strcssclass) // set
ProgressBar.cssclass // get
```
...
**Syntax**
```javascript
ProgressBar.set_cursor(strCursor) // set
ProgressBar.cursor // get
```
...
**Syntax**
```javascript
ProgressBar.set_direction(enumDirection) // set
ProgressBar.direction // get
```
...
**Syntax**
```javascript
ProgressBar.set_enable(benable) // set
ProgressBar.enable // get
```

**Setting Syntax**
```javascript
ProgressBar 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
ProgressBar.set_enableevent(bEvent) // set
ProgressBar.enableevent // get
```

**Setting Syntax**
```javascript
ProgressBar 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
ProgressBar.set_expr(strExpr) // set
ProgressBar.expr // get
```
...
**Remark**
- 동적으로 ProgressBar 에 적용된 텍스트는 getDisplayText() 메소드를 사용하여 확인할 수 있습니다.
...
**Syntax**
```javascript
ProgressBar.set_flexgrow(fVal) // set
ProgressBar.flexgrow // get
```
...
**Syntax**
```javascript
ProgressBar.set_flexshrink(fVal) // set
ProgressBar.flexshrink // get
```
...
**Syntax**
```javascript
ProgressBar.set_font(strfont) // set
ProgressBar.font // get
```
...
**Syntax**
```javascript
ProgressBar.set_height(nHeight) // set
ProgressBar.height // get
```

**Setting Syntax**
```javascript
ProgressBar 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 ProgressBar 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 ProgressBar 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
ProgressBar.set_hotkey(strHotkey) // set
ProgressBar.hotkey // get
```
...
**Setting Syntax**
```javascript
ProgressBar를 구별할 수 있는 유일값을 갖습니다.
```
...
**Syntax**
```javascript
ProgressBar.set_initvalueid(strValueID) // set
ProgressBar.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 ProgressBar 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
ProgressBar.set_layoutorder(nVal) // set
ProgressBar.layoutorder // get
```
...
**Syntax**
```javascript
ProgressBar.set_left(nLeft) // set
ProgressBar.left // get
```

**Setting Syntax**
```javascript
ProgressBar 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 ProgressBar 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 ProgressBar 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 ProgressBar 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 ProgressBar 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
ProgressBar.set_letterSpacing(strspace) // set
ProgressBar.letterSpacing // get
```
...
**Syntax**
```javascript
ProgressBar.set_max(nMax) // set
ProgressBar.max // get
```

**Setting Syntax**
```javascript
최대값을 0 이상의 정수로 설정합니다.
...
**Syntax**
```javascript
ProgressBar.set_maxheight(nMaxHeight) // set
ProgressBar.maxheight // get
```

**Setting Syntax**
```javascript
ProgressBar 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ProgressBar.set_maxwidth(nMaxWidth) // set
ProgressBar.maxwidth // get
```

**Setting Syntax**
```javascript
ProgressBar 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ProgressBar.set_min(nMin) // set
ProgressBar.min // get
```

**Setting Syntax**
```javascript
최소값을 0 이상의 정수로 설정합니다.
0 미만의 값을 설정하면 0으로 적용됩니다.
```
...
**Syntax**
```javascript
ProgressBar.set_minheight(nMinHeight) // set
ProgressBar.minheight // get
```

**Setting Syntax**
```javascript
ProgressBar 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ProgressBar.set_minwidth(nMinWidth) // set
ProgressBar.minwidth // get
```

**Setting Syntax**
```javascript
ProgressBar 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ProgressBar.set_name(strName) // set
ProgressBar.name // get
```
...
**Syntax**
```javascript
ProgressBar.set_opacity(strOpacity) // set
ProgressBar.opacity // get
```
...
**Syntax**
```javascript
ProgressBar.set_pos(nPos) // set
ProgressBar.pos // get
```

**Setting Syntax**
```javascript
진행바의 위치를 숫자값으로 설정합니다.
...
**Syntax**
```javascript
ProgressBar.set_positionstep(nStep) // set
ProgressBar.positionstep // get
```

**Setting Syntax**
```javascript
ProgressBar 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
ProgressBar.set_right(nRight) // set
ProgressBar.right // get
```

**Setting Syntax**
```javascript
ProgressBar 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 ProgressBar 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 ProgressBar 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 ProgressBar 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 ProgressBar 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
ProgressBar 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
ProgressBar.set_smooth(bSmooth) // set
ProgressBar.smooth // get
```
...
**Syntax**
```javascript
ProgressBar.set_step(nStep) // set
ProgressBar.step // get
```

**Setting Syntax**
```javascript
pos 속성에 더해질 값을 숫자로 설정합니다.
...
**Syntax**
```javascript
ProgressBar.set_tablecellarea(strArea) // set
ProgressBar.tablecellarea // get
```
...
**Syntax**
```javascript
ProgressBar.set_taborder(nTabOrder) // set
ProgressBar.taborder // get
```
...
**Syntax**
```javascript
ProgressBar.set_tabstop(bTabStop) // set
ProgressBar.tabstop // get
```

**Setting Syntax**
```javascript
ProgressBar 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
ProgressBar.set_text(strText) // set
ProgressBar.text // get
```

**Setting Syntax**
```javascript
ProgressBar 에 표시될 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
ProgressBar.set_tooltiptext(strToolTipText) // set
ProgressBar.tooltiptext // get
```
...
**Syntax**
```javascript
ProgressBar.set_tooltiptype(enumTooltipType) // set
ProgressBar.tooltiptype // get
```

**Setting Syntax**
```javascript
ProgressBar 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
ProgressBar.set_top(nTop) // set
ProgressBar.top // get
```

**Setting Syntax**
```javascript
ProgressBar 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 ProgressBar 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 ProgressBar 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 ProgressBar 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 ProgressBar 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
ProgressBar.set_visible(bVisible) // set
ProgressBar.visible // get
```

**Setting Syntax**
```javascript
ProgressBar 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
ProgressBar.set_width(nWidth) // set
ProgressBar.width // get
```

**Setting Syntax**
```javascript
ProgressBar 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 ProgressBar 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 ProgressBar 의 너비가 결정됩니다.
```
