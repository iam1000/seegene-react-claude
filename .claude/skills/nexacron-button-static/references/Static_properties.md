...
| `accessibilityaction` | Static에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action |
| `accessibilitydesclevel` | Static 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | Static에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 descri |
| `accessibilityenable` | Static 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | Static에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label  |
...
**Syntax**
```javascript
Static.set_border(strborder) // set
Static.border // get
```
...
**Syntax**
```javascript
Static.set_padding(strpadding) // set
Static.padding // get
```

**Setting Syntax**
```javascript
Static 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
Static.set_textAlign(strtextalign) // set
Static.textAlign // get
```
...
**Syntax**
```javascript
Static.set_textDecoration(strTxtDeco) // set
Static.textDecoration // get
```
...
**Syntax**
```javascript
Static.set_verticalAlign(strvertalign) // set
Static.verticalAlign // get
```
...
**Syntax**
```javascript
Static.set_wordWrap(strwordwrap) // set
Static.wordWrap // get
```
...
**Syntax**
```javascript
Static.set_accessibilityaction(strAction) // set
Static.accessibilityaction // get
```
...
**Syntax**
```javascript
Static.set_accessibilitydesclevel(enumLevel) // set
Static.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
Static 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
Static.set_accessibilitydescription(strDescription) // set
Static.accessibilitydescription // get
```
...
**Syntax**
```javascript
Static.set_accessibilityenable(bEnable) // set
Static.accessibilityenable // get
```

**Setting Syntax**
```javascript
Static 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
Static.set_accessibilitylabel(strLabel) // set
Static.accessibilitylabel // get
```
...
**Syntax**
```javascript
Static.set_accessibilityrole(enumRole) // set
Static.accessibilityrole // get
```
...
**Syntax**
```javascript
Static.set_background( strBackground ) // set 
...
**Syntax**
```javascript
Static.set_borderRadius(strborderradius) // set
...
**Syntax**
```javascript
Static.set_bottom(nBottom) // set
Static.bottom // get
```

**Setting Syntax**
```javascript
Static 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 Static 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Static 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 Static 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Static 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Static.set_boxShadow(strbshadow) // set
...
**Syntax**
```javascript
Static.set_cssclass(strcssclass) // set
Static.cssclass // get
```
...
**Syntax**
```javascript
Static.set_cursor(strCursor) // set
Static.cursor // get
```
...
**Syntax**
```javascript
Static.set_enable(benable) // set
Static.enable // get
```

**Setting Syntax**
```javascript
Static 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
Static.set_enableevent(bEvent) // set
Static.enableevent // get
```

**Setting Syntax**
```javascript
Static 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Remark**
- 동적으로 Static 에 적용된 텍스트는 getDisplayText() 메소드를 사용하여 확인할 수 있습니다.
...
**Syntax**
```javascript
Static.set_fittocontents(enumFitTo) // set
Static.fittocontents // get
```

**Setting Syntax**
```javascript
컨텐츠 내용에 맞게 Static 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.
```
...
**Syntax**
```javascript
Static.set_flexshrink(fVal) // set
Static.flexshrink // get
```
...
**Syntax**
```javascript
Static.set_height(nHeight) // set
Static.height // get
```

**Setting Syntax**
```javascript
Static 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Static 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Static 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
Static.set_hotkey(strHotkey) // set
Static.hotkey // get
```
...
**Syntax**
```javascript
Static.set_initvalueid(strValueID) // set
Static.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 Static 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Static.set_layoutorder(nVal) // set
Static.layoutorder // get
```
...
**Syntax**
```javascript
Static.set_left(nLeft) // set
Static.left // get
```

**Setting Syntax**
```javascript
Static 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 Static 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Static 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 Static 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Static 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Static.set_letterSpacing(strspace) // set
Static.letterSpacing // get
```
...
**Syntax**
```javascript
Static.set_maxheight(nMaxHeight) // set
Static.maxheight // get
```

**Setting Syntax**
```javascript
Static 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Static.set_maxwidth(nMaxWidth) // set
Static.maxwidth // get
```

**Setting Syntax**
```javascript
Static 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Static.set_minheight(nMinHeight) // set
Static.minheight // get
```

**Setting Syntax**
```javascript
Static 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Static.set_minwidth(nMinWidth) // set
Static.minwidth // get
```

**Setting Syntax**
```javascript
Static 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Static.set_opacity(strOpacity) // set
Static.opacity // get
```
...
**Syntax**
```javascript
Static.set_positionstep(nStep) // set
Static.positionstep // get
```

**Setting Syntax**
```javascript
Static 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
Static.set_right(nRight) // set
Static.right // get
```

**Setting Syntax**
```javascript
Static 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 Static 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Static 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 Static 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Static 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
Static 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
Static.set_tablecellarea(strArea) // set
Static.tablecellarea // get
```
...
**Syntax**
```javascript
Static.set_taborder(nTabOrder) // set
Static.taborder // get
```
...
**Syntax**
```javascript
Static.set_text(strText) // set
Static.text // get
```

**Setting Syntax**
```javascript
Static 에 표시될 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
Static.set_tooltiptext(strToolTipText) // set
...
**Syntax**
```javascript
Static.set_tooltiptype(enumTooltipType) // set
Static.tooltiptype // get
```

**Setting Syntax**
```javascript
Static 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
Static.set_top(nTop) // set
Static.top // get
```

**Setting Syntax**
```javascript
Static 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 Static 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Static 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 Static 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Static 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Static.set_usedecorate(bDecorate) // set
Static.usedecorate // get
```

**Setting Syntax**
```javascript
텍스트에 Decorate 효과를 적용하지 않습니다.
```
...
**Syntax**
```javascript
Static.set_visible(bVisible) // set
Static.visible // get
```

**Setting Syntax**
```javascript
Static 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
Static.set_width(nWidth) // set
Static.width // get
```

**Setting Syntax**
```javascript
Static 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Static 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Static 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
Static.set_wordSpacing(strWordSpacing) // set
Static.wordSpacing // get
```
