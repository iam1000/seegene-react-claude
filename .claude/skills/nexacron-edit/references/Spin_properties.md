...
| `accessibilityaction` | Spin에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정 |
| `accessibilitydesclevel` | Spin 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | Spin에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 descript |
| `accessibilityenable` | Spin 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | Spin에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보 |
...
**Syntax**
```javascript
Spin.set_padding(strpadding) // set
Spin.padding // get
```

**Setting Syntax**
```javascript
Spin 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
Spin.set_accessibilityaction(strAction) // set
Spin.accessibilityaction // get
```
...
**Syntax**
```javascript
Spin.set_accessibilitydesclevel(enumLevel) // set
Spin.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
Spin 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
Spin.set_accessibilitydescription(strDescription) // set
Spin.accessibilitydescription // get
```
...
**Syntax**
```javascript
Spin.set_accessibilityenable(bEnable) // set
Spin.accessibilityenable // get
```

**Setting Syntax**
```javascript
Spin 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
Spin.set_accessibilitylabel(strLabel) // set
Spin.accessibilitylabel // get
```
...
**Syntax**
```javascript
Spin.set_accessibilityrole(enumRole) // set
Spin.accessibilityrole // get
```
...
**Syntax**
```javascript
Spin.set_background( strBackground ) // set 
Spin.background // get
```
...
**Syntax**
```javascript
Spin.set_borderRadius(strborderradius) // set
Spin.borderRadius // get
```
...
**Syntax**
```javascript
Spin.set_bottom(nBottom) // set
Spin.bottom // get
```

**Setting Syntax**
```javascript
Spin 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 Spin 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Spin 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 Spin 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Spin 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Spin.set_boxShadow(strbshadow) // set
Spin.boxShadow // get
```
...
**Syntax**
```javascript
Spin.set_buttonposition(enumAlign) // set
Spin.buttonposition // get
```

**Setting Syntax**
```javascript
스핀버튼이 편집 영역의 오른쪽에 표시됩니다.
```
...
**Syntax**
```javascript
Spin.set_buttonsize(nButtonSize) // set
Spin.buttonsize // get
```

**Setting Syntax**
```javascript
스핀버튼의 가로 크기를 pixel 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
Spin.set_circulation(bCriculation) // set
Spin.circulation // get
```

**Setting Syntax**
```javascript
value 속성값이 min 속성값과 같을 때 스핀다운버튼을 클릭해도 value 속성값이 변경되지 않습니다.
...
**Syntax**
```javascript
Spin.set_cssclass(strcssclass) // set
Spin.cssclass // get
```
...
**Syntax**
```javascript
Spin.set_displaycomma(bDisplayComma) // set
Spin.displaycomma // get
```

**Setting Syntax**
```javascript
value 속성값이 1000 이상이어도 콤마를 표시하지 않습니다.
```
...
**Syntax**
```javascript
Spin.set_displayinvalidtext( strText ) // set 
Spin.displayinvalidtext // get
```

**Setting Syntax**
```javascript
value 속성값이 NaN, ±Infinity, 유효하지 않은 값 일 때 Spin 에 표시될 대체 문자열을 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_displaynulltext(strText) // set
Spin.displaynulltext // get
```

**Setting Syntax**
```javascript
value 속성값이 null 일 때 Spin 에 표시될 대체 문자열을 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_enable(benable) // set
Spin.enable // get
```

**Setting Syntax**
```javascript
Spin 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
Spin.set_enableevent(bEvent) // set
Spin.enableevent // get
```

**Setting Syntax**
```javascript
Spin 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_height(nHeight) // set
Spin.height // get
```

**Setting Syntax**
```javascript
Spin 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Spin 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Spin 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
Spin.set_increment(nIncrement) // set
Spin.increment // get
```

**Setting Syntax**
```javascript
스핀버튼 클릭 시 value 속성값을 증가/감소 시킬 실수값을 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_initvalueid(strValueID) // set
Spin.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 Spin 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_layoutorder(nVal) // set
Spin.layoutorder // get
```
...
**Syntax**
```javascript
Spin.set_left(nLeft) // set
Spin.left // get
```

**Setting Syntax**
```javascript
Spin 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 Spin 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Spin 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 Spin 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Spin 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Spin.set_letterSpacing(strspace) // set
Spin.letterSpacing // get
```
...
**Syntax**
```javascript
Spin.set_max(nMax) // set
Spin.max // get
```

**Setting Syntax**
```javascript
value 속성이 가질 수 있는 최대값을 실수로 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_maxheight(nMaxHeight) // set
Spin.maxheight // get
```

**Setting Syntax**
```javascript
Spin 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_maxwidth(nMaxWidth) // set
Spin.maxwidth // get
```

**Setting Syntax**
```javascript
Spin 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_minheight(nMinHeight) // set
Spin.minheight // get
```

**Setting Syntax**
```javascript
Spin 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_minwidth(nMinWidth) // set
Spin.minwidth // get
```

**Setting Syntax**
```javascript
Spin 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_opacity(strOpacity) // set
Spin.opacity // get
```
...
**Syntax**
```javascript
Spin.set_positionstep(nStep) // set
Spin.positionstep // get
```

**Setting Syntax**
```javascript
Spin 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
Spin.set_readonly(bReadOnly) // set
Spin.readonly // get
```

**Setting Syntax**
```javascript
Spin 의 편집을 가능하게 설정합니다.
```
...
**Syntax**
```javascript
Spin.set_right(nRight) // set
Spin.right // get
```

**Setting Syntax**
```javascript
Spin 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 Spin 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Spin 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 Spin 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Spin 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
Spin 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
Spin.set_tablecellarea(strArea) // set
Spin.tablecellarea // get
```
...
**Syntax**
```javascript
Spin.set_taborder(nTabOrder) // set
Spin.taborder // get
```
...
**Syntax**
```javascript
Spin.set_tabstop(bTabStop) // set
Spin.tabstop // get
```

**Setting Syntax**
```javascript
Spin 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
Spin.set_tooltiptext(strToolTipText) // set
Spin.tooltiptext // get
```
...
**Syntax**
```javascript
Spin.set_tooltiptype(enumTooltipType) // set
Spin.tooltiptype // get
```

**Setting Syntax**
```javascript
Spin 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
Spin.set_top(nTop) // set
Spin.top // get
```

**Setting Syntax**
```javascript
Spin 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 Spin 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Spin 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 Spin 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Spin 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Spin.set_type(enumType) // set
Spin.type // get
```

**Setting Syntax**
```javascript
편집영역 없이 스핀버튼만 있는 Spin이 표시됩니다.
```
...
**Syntax**
```javascript
Spin.set_usecontextmenu(bUseContextMenu) // set
Spin.usecontextmenu // get
```
...
**Syntax**
```javascript
Spin.set_usesoftkeyboard(bUseKeyboard) // set
Spin.usesoftkeyboard // get
```

**Setting Syntax**
```javascript
Spin 가 포커스를 가질 때 키패드가 표시되지 않습니다.
```
...
**Syntax**
```javascript
Spin.set_value(nValue) // set
Spin.value // get
```

**Setting Syntax**
```javascript
Spin 이 갖는 실제 값을 실수로 설정합니다.
...
**Syntax**
```javascript
Spin.set_visible(bVisible) // set
Spin.visible // get
```

**Setting Syntax**
```javascript
Spin 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
Spin.set_width(nWidth) // set
Spin.width // get
```

**Setting Syntax**
```javascript
Spin 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Spin 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Spin 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
Spin.set_wordSpacing(strWordSpacing) // set
Spin.wordSpacing // get
```
