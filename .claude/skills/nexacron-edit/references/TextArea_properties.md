...
| `accessibilityaction` | TextArea에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 acti |
| `accessibilitydesclevel` | TextArea 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | TextArea에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 desc |
| `accessibilityenable` | TextArea 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | TextArea에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 labe |
...
| `dragscrolltype` | TextArea 에서 터치 후 드래그에 의해 스크롤이 발생 할 경우 스크롤 방향을 설정하는 속성입니다. |
...
**Syntax**
```javascript
TextArea.set_border(strborder) // set
TextArea.border // get
```
...
**Syntax**
```javascript
TextArea.set_padding(strpadding) // set
TextArea.padding // get
```

**Setting Syntax**
```javascript
TextArea 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
TextArea.set_textAlign(strtextalign) // set
TextArea.textAlign // get
```
...
**Syntax**
```javascript
TextArea.set_textDecoration(strTxtDeco) // set
TextArea.textDecoration // get
```
...
**Syntax**
```javascript
TextArea.set_wordWrap(strwordwrap) // set
TextArea.wordWrap // get
```
...
**Syntax**
```javascript
TextArea.set_acceptstab(bTab) // set
TextArea.acceptstab // get
```

**Setting Syntax**
```javascript
들여쓰기를 하려면 "Ctrl + Tab"키를 입력하여야 합니다.
...
**Syntax**
```javascript
TextArea.set_accessibilityaction(strAction) // set
TextArea.accessibilityaction // get
```
...
**Syntax**
```javascript
TextArea.set_accessibilitydesclevel(enumLevel) // set
TextArea.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
TextArea 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
TextArea.set_accessibilitydescription(strDescription) // set
TextArea.accessibilitydescription // get
```
...
**Syntax**
```javascript
TextArea.set_accessibilityenable(bEnable) // set
TextArea.accessibilityenable // get
```

**Setting Syntax**
```javascript
TextArea 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
TextArea.set_accessibilitylabel(strLabel) // set
TextArea.accessibilitylabel // get
```
...
**Syntax**
```javascript
TextArea.set_accessibilityrole(enumRole) // set
TextArea.accessibilityrole // get
```
...
**Syntax**
```javascript
TextArea.set_autoskip(bAutoskip) // set
TextArea.autoskip // get
```

**Setting Syntax**
```javascript
문자열 길이가 maxlength 속성값에 도달해도 포커스를 이동시키지 않습니다.
```
...
**Syntax**
```javascript
TextArea.set_background( strBackground ) // set 
TextArea.background // get
```
...
**Syntax**
```javascript
TextArea.set_borderRadius(strborderradius) // set
TextArea.borderRadius // get
```
...
**Syntax**
```javascript
TextArea.set_bottom(nBottom) // set
TextArea.bottom // get
```

**Setting Syntax**
```javascript
TextArea 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 TextArea 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 TextArea 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 TextArea 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 TextArea 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
TextArea.set_boxShadow(strbshadow) // set
TextArea.boxShadow // get
```
...
**Syntax**
```javascript
TextArea.set_color(strcolor) // set
TextArea.color // get
```
...
**Syntax**
```javascript
TextArea.set_cssclass(strcssclass) // set
TextArea.cssclass // get
```
...
**Syntax**
```javascript
TextArea.set_cursor(strCursor) // set
TextArea.cursor // get
```
...
**Syntax**
```javascript
TextArea.set_displaynulltext(strText) // set
TextArea.displaynulltext // get
```

**Setting Syntax**
```javascript
value 속성값이 null 일 때 TextArea 에 표시될 대체 문자열을 설정합니다.
```
...
TextArea 에서 터치 후 드래그에 의해 스크롤이 발생 할 경우 스크롤 방향을 설정하는 속성입니다.

**Syntax**
```javascript
TextArea.set_dragscrolltype(enumType) // set
TextArea.dragscrolltype // get
```

**Setting Syntax**
```javascript
터치 후 드래그에 의해 수직/수평/대각선 스크롤 모두 발생합니다.
```

**Remark**
- dragscrolltype 속성값을 설정하지 않으면 "all" 로 적용됩니다.

- Environment 의 enabletouchevent 속성값이 true 인 경우에만 속성이 적용됩니다.
...
**Syntax**
```javascript
TextArea.set_enable(benable) // set
TextArea.enable // get
```

**Setting Syntax**
```javascript
TextArea 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
TextArea.set_enableevent(bEvent) // set
TextArea.enableevent // get
```

**Setting Syntax**
```javascript
TextArea 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
TextArea.set_flexgrow(fVal) // set
TextArea.flexgrow // get
```
...
**Syntax**
```javascript
TextArea.set_flexshrink(fVal) // set
TextArea.flexshrink // get
```
...
**Syntax**
```javascript
TextArea.set_height(nHeight) // set
TextArea.height // get
```

**Setting Syntax**
```javascript
TextArea 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 TextArea 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 TextArea 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
TextArea.set_hotkey(strHotkey) // set
TextArea.hotkey // get
```
...
**Setting Syntax**
```javascript
this.TextArea00.hscrollbar.set_decbuttonsize( 30 );
```
...
- 스크롤바의 트랙바가 표시되는 영역을 클릭했을 때 Windows10 의 IE11 환경에서 캐럿이 표시된 위치로 스크롤이 한번 이동하는 현상이 있습니다.
   해당 영역 클릭으로 TextArea 가 포커스 되면 IE11 이 강제로 캐럿 위치로 스크롤을 이동시키고,
   그 후에 넥사크로에서 스크롤을 보정하기 때문에 발생하는 현상으로 버그가 아닌 브라우저 제약 사항입니다.
...
**Syntax**
```javascript
TextArea.set_imemode(enumImemode) // set
TextArea.imemode // get
```
...
**Syntax**
```javascript
TextArea.set_initvalueid(strValueID) // set
TextArea.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 TextArea 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
TextArea.set_inputfilter(strInputfilter) // set
TextArea.inputfilter // get
```
...
**Syntax**
```javascript
TextArea.set_inputmode(enumInputmode) // set
TextArea.inputmode // get
```
...
**Syntax**
```javascript
TextArea.set_inputtype(strInputtype) // set
TextArea.inputtype // get
```
...
**Syntax**
```javascript
TextArea.set_layoutorder(nVal) // set
TextArea.layoutorder // get
```
...
**Syntax**
```javascript
TextArea.set_left(nLeft) // set
TextArea.left // get
```

**Setting Syntax**
```javascript
TextArea 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 TextArea 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 TextArea 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 TextArea 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 TextArea 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
TextArea.set_letterSpacing(strspace) // set
TextArea.letterSpacing // get
```
...
**Syntax**
```javascript
TextArea.set_maxheight(nMaxHeight) // set
TextArea.maxheight // get
```

**Setting Syntax**
```javascript
TextArea 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TextArea.set_maxlength(nMaxlength) // set
TextArea.maxlength // get
```
...
**Syntax**
```javascript
TextArea.set_maxwidth(nMaxWidth) // set
TextArea.maxwidth // get
```

**Setting Syntax**
```javascript
TextArea 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TextArea.set_minheight(nMinHeight) // set
TextArea.minheight // get
```

**Setting Syntax**
```javascript
TextArea 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TextArea.set_minwidth(nMinWidth) // set
TextArea.minwidth // get
```

**Setting Syntax**
```javascript
TextArea 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TextArea.set_opacity(strOpacity) // set
TextArea.opacity // get
```
...
**Syntax**
```javascript
TextArea.set_positionstep(nStep) // set
TextArea.positionstep // get
```

**Setting Syntax**
```javascript
TextArea 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
TextArea.set_readonly(bReadOnly) // set
TextArea.readonly // get
```

**Setting Syntax**
```javascript
TextArea 의 편집을 가능하게 설정합니다.
```
...
**Syntax**
```javascript
TextArea.set_right(nRight) // set
TextArea.right // get
```

**Setting Syntax**
```javascript
TextArea 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 TextArea 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 TextArea 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 TextArea 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 TextArea 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
TextArea 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
TextArea.set_scrollbarbarminsize( nSize ) // set 
TextArea.scrollbarbarminsize // get
```
...
**Syntax**
```javascript
TextArea.set_scrollbarbaroutsize( nSize ) // set 
TextArea.scrollbarbaroutsize // get
```
...
**Syntax**
```javascript
TextArea.set_scrollbardecbuttonsize(nSize) // set
TextArea.scrollbardecbuttonsize // get
```
...
**Syntax**
```javascript
TextArea.set_scrollbarincbuttonsize(nSize) // set
TextArea.scrollbarincbuttonsize // get
```
...
**Syntax**
```javascript
TextArea.set_scrollbarsize(nSize) // set
TextArea.scrollbarsize // get
```
...
**Syntax**
```javascript
TextArea.set_scrollbartrackbarsize( nSize ) // set 
TextArea.scrollbartrackbarsize // get
```
...
**Syntax**
```javascript
TextArea.set_scrollbartype(strBartype) // set
TextArea.scrollbartype // get
```
...
**Syntax**
```javascript
TextArea.set_scrollindicatorsize(nSize) // set
TextArea.scrollindicatorsize // get
```
...
**Syntax**
```javascript
TextArea.set_scrolltype(enumType) // set
TextArea.scrolltype // get
```

**Setting Syntax**
```javascript
TextArea 에서 수평 스크롤만 사용합니다.
...
**Syntax**
```javascript
TextArea.set_tablecellarea(strArea) // set
TextArea.tablecellarea // get
```
...
**Syntax**
```javascript
TextArea.set_taborder(nTabOrder) // set
TextArea.taborder // get
```
...
**Syntax**
```javascript
TextArea.set_tabstop(bTabStop) // set
TextArea.tabstop // get
```

**Setting Syntax**
```javascript
TextArea 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
TextArea.set_tooltiptext(strToolTipText) // set
TextArea.tooltiptext // get
```
...
**Syntax**
```javascript
TextArea.set_tooltiptype(enumTooltipType) // set
TextArea.tooltiptype // get
```

**Setting Syntax**
```javascript
TextArea 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
TextArea.set_top(nTop) // set
TextArea.top // get
```

**Setting Syntax**
```javascript
TextArea 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 TextArea 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 TextArea 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 TextArea 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 TextArea 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
TextArea.set_usecontextmenu(bUseContextMenu) // set
TextArea.usecontextmenu // get
```
...
**Syntax**
```javascript
TextArea.set_usesoftkeyboard(bUseKeyboard) // set
TextArea.usesoftkeyboard // get
```

**Setting Syntax**
```javascript
TextArea 가 포커스를 가질 때 키패드가 표시되지 않습니다.
```
...
**Syntax**
```javascript
TextArea.set_value(strValue) // set
TextArea.value // get
```
...
**Syntax**
```javascript
TextArea.set_visible(bVisible) // set
TextArea.visible // get
```

**Setting Syntax**
```javascript
TextArea 을(를) 화면에 표시하지 않습니다.
```
...
**Setting Syntax**
```javascript
this.TextArea00.vscrollbar.set_decbuttonsize( 30 );
```
...
**Syntax**
```javascript
TextArea.set_width(nWidth) // set
TextArea.width // get
```

**Setting Syntax**
```javascript
TextArea 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 TextArea 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 TextArea 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
TextArea.set_wordSpacing(strWordSpacing) // set
TextArea.wordSpacing // get
```
