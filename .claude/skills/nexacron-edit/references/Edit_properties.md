...
| `accessibilityaction` | Edit에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정 |
| `accessibilitydesclevel` | Edit 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | Edit에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 descript |
| `accessibilityenable` | Edit 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | Edit에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보 |
...
**Syntax**
```javascript
Edit.set_padding(strpadding) // set
Edit.padding // get
```

**Setting Syntax**
```javascript
Edit 와 내부 텍스트영역 사이의 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
Edit.set_textAlign(strtextalign) // set
Edit.textAlign // get
```
...
**Syntax**
```javascript
Edit.set_textDecoration(strTxtDeco) // set
Edit.textDecoration // get
```
...
**Syntax**
```javascript
Edit.set_accessibilityaction(strAction) // set
Edit.accessibilityaction // get
```
...
**Syntax**
```javascript
Edit.set_accessibilitydesclevel(enumLevel) // set
Edit.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
Edit 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
Edit.set_accessibilitydescription(strDescription) // set
Edit.accessibilitydescription // get
```
...
**Syntax**
```javascript
Edit.set_accessibilityenable(bEnable) // set
Edit.accessibilityenable // get
```

**Setting Syntax**
```javascript
Edit 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
Edit.set_accessibilitylabel(strLabel) // set
Edit.accessibilitylabel // get
```
...
**Syntax**
```javascript
Edit.set_accessibilityrole(enumRole) // set
Edit.accessibilityrole // get
```
...
**Syntax**
```javascript
Edit.set_autoselect(bAutoselect) // set
Edit.autoselect // get
```
...
**Syntax**
```javascript
Edit.set_autoskip(bAutoskip) // set
Edit.autoskip // get
```
...
**Syntax**
```javascript
Edit.set_background( strBackground ) // set 
Edit.background // get
```
...
**Syntax**
```javascript
Edit.set_borderRadius(strborderradius) // set
Edit.borderRadius // get
```
...
**Syntax**
```javascript
Edit.set_bottom(nBottom) // set
Edit.bottom // get
```

**Setting Syntax**
```javascript
Edit 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 Edit 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Edit 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 Edit 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Edit 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Edit.set_boxShadow(strbshadow) // set
Edit.boxShadow // get
```
...
**Syntax**
```javascript
Edit.set_cssclass(strcssclass) // set
Edit.cssclass // get
```
...
**Syntax**
```javascript
Edit.set_displaynulltext(strText) // set
Edit.displaynulltext // get
```

**Setting Syntax**
```javascript
value 속성값이 null 일 때 Edit 에 표시될 대체 문자열을 설정합니다.
```
...
**Syntax**
```javascript
Edit.set_enable(benable) // set
Edit.enable // get
```

**Setting Syntax**
```javascript
Edit 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
Edit.set_enableevent(bEvent) // set
Edit.enableevent // get
```

**Setting Syntax**
```javascript
Edit 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
Edit.set_height(nHeight) // set
Edit.height // get
```

**Setting Syntax**
```javascript
Edit 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Edit 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Edit 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
Edit.set_imeaction(enumImeaction)
Edit.imeaction
```
...
**Syntax**
```javascript
Edit.set_imemode(enumImemode) // set
Edit.imemode // get
```
...
**Syntax**
```javascript
Edit.set_initvalueid(strValueID) // set
Edit.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 Edit 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Edit.set_inputfilter(strInputfilter) // set
Edit.inputfilter // get
```
...
**Syntax**
```javascript
Edit.set_inputmode(enumInputmode) // set
Edit.inputmode // get
```
...
**Syntax**
```javascript
Edit.set_inputtype(strInputtype) // set
Edit.inputtype // get
```
...
**Syntax**
```javascript
Edit.set_layoutorder(nVal) // set
Edit.layoutorder // get
```
...
**Syntax**
```javascript
Edit.set_left(nLeft) // set
Edit.left // get
```

**Setting Syntax**
```javascript
Edit 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 Edit 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Edit 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 Edit 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Edit 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Edit.set_letterSpacing(strspace) // set
Edit.letterSpacing // get
```
...
**Syntax**
```javascript
Edit.set_maxheight(nMaxHeight) // set
Edit.maxheight // get
```

**Setting Syntax**
```javascript
Edit 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Edit.set_maxlength(nMaxlength) // set
Edit.maxlength // get
```
...
**Syntax**
```javascript
Edit.set_maxwidth(nMaxWidth) // set
Edit.maxwidth // get
```

**Setting Syntax**
```javascript
Edit 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Edit.set_minheight(nMinHeight) // set
Edit.minheight // get
```

**Setting Syntax**
```javascript
Edit 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Edit.set_minwidth(nMinWidth) // set
Edit.minwidth // get
```

**Setting Syntax**
```javascript
Edit 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Edit.set_opacity(strOpacity) // set
Edit.opacity // get
```
...
**Syntax**
```javascript
Edit.set_password(bPassword) // set
Edit.password // get
```

**Setting Syntax**
```javascript
입력하는 문자나 표시하는 문자를 특수문자로 대체하지 않고 그대로 표시합니다.
```
...
**Syntax**
```javascript
Edit.set_positionstep(nStep) // set
Edit.positionstep // get
```

**Setting Syntax**
```javascript
Edit 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
Edit.set_readonly(bReadOnly) // set
Edit.readonly // get
```

**Setting Syntax**
```javascript
Edit 의 편집을 가능하게 설정합니다.
```
...
**Syntax**
```javascript
Edit.set_right(nRight) // set
Edit.right // get
```

**Setting Syntax**
```javascript
Edit 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 Edit 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Edit 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 Edit 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Edit 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
Edit 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
Edit.set_tablecellarea(strArea) // set
Edit.tablecellarea // get
```
...
**Syntax**
```javascript
Edit.set_taborder(nTabOrder) // set
Edit.taborder // get
```
...
**Syntax**
```javascript
Edit.set_tabstop(bTabStop) // set
Edit.tabstop // get
```

**Setting Syntax**
```javascript
Edit 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
Edit.set_tooltiptext(strToolTipText) // set
Edit.tooltiptext // get
```
...
**Syntax**
```javascript
Edit.set_tooltiptype(enumTooltipType) // set
Edit.tooltiptype // get
```

**Setting Syntax**
```javascript
Edit 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
Edit.set_top(nTop) // set
Edit.top // get
```

**Setting Syntax**
```javascript
Edit 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 Edit 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Edit 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 Edit 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Edit 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Edit.set_usecontextmenu(bUseContextMenu) // set
Edit.usecontextmenu // get
```
...
**Syntax**
```javascript
Edit.set_usesoftkeyboard(bUseKeyboard) // set
Edit.usesoftkeyboard // get
```

**Setting Syntax**
```javascript
Edit 가 포커스를 가질 때 키패드가 표시되지 않습니다.
```
...
**Syntax**
```javascript
Edit.set_visible(bVisible) // set
Edit.visible // get
```

**Setting Syntax**
```javascript
Edit 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
Edit.set_width(nWidth) // set
Edit.width // get
```

**Setting Syntax**
```javascript
Edit 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Edit 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Edit 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
Edit.set_wordSpacing(strWordSpacing) // set
Edit.wordSpacing // get
```
