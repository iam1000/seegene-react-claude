...
| `accessibilityaction` | Div에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보 |
| `accessibilitydesclevel` | Div 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | Div에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 descripti |
| `accessibilityenable` | Div 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | Div에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 |
...
**Syntax**
```javascript
Div.set_accessibilityaction(strAction) // set
Div.accessibilityaction // get
```
...
**Syntax**
```javascript
Div.set_accessibilitydesclevel(enumLevel) // set
Div.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
Div 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
Div.set_accessibilitydescription(strDescription) // set
Div.accessibilitydescription // get
```
...
**Syntax**
```javascript
Div.set_accessibilityenable(bEnable) // set
Div.accessibilityenable // get
```

**Setting Syntax**
```javascript
Div 에 선택상자가 이동되지 않습니다.
```
...
- 모바일 환경에서는 선택상자가 Div 컴포넌트 자체가 아닌, Div 컴포넌트 내부로 이동됩니다.
...
**Syntax**
```javascript
Div.set_accessibilitylabel(strLabel) // set
Div.accessibilitylabel // get
```
...
**Syntax**
```javascript
Div.set_accessibilityrole(enumRole) // set
Div.accessibilityrole // get
```
...
**Syntax**
```javascript
Div.set_async(bAsync) // set
Div.async // get
```

**Setting Syntax**
```javascript
Div 에 Form 을 동기(Sync) 방식으로 로드합니다.
...
**Syntax**
```javascript
Div.set_background( strBackground ) // set 
Div.background // get
```
...
**Syntax**
```javascript
Div.set_borderRadius(strborderradius) // set
Div.borderRadius // get
```
...
**Syntax**
```javascript
Div.set_bottom(nBottom) // set
Div.bottom // get
```

**Setting Syntax**
```javascript
Div 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 Div 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Div 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 Div 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Div 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Div.set_boxShadow(strbshadow) // set
Div.boxShadow // get
```
...
**Syntax**
```javascript
Div.set_cssclass(strcssclass) // set
Div.cssclass // get
```
...
**Syntax**
```javascript
Div.set_enable(benable) // set
Div.enable // get
```

**Setting Syntax**
```javascript
Div 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
Div.set_enableevent(bEvent) // set
Div.enableevent // get
```

**Setting Syntax**
```javascript
Div 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
Div.set_formscrollbarbarminsize(nSize) // set
Div.formscrollbarbarminsize // get
```
...
**Syntax**
```javascript
Div.set_formscrollbarbaroutsize(nSize) // set
Div.formscrollbarbaroutsize // get
```
...
**Syntax**
```javascript
Div.set_formscrollbardecbuttonsize(nSize) // set
Div.formscrollbardecbuttonsize // get
```
...
**Syntax**
```javascript
Div.set_formscrollbarincbuttonsize(nSize) // set
Div.formscrollbarincbuttonsize // get
```
...
**Syntax**
```javascript
Div.set_formscrollbarsize(nSize) // set
Div.formscrollbarsize // get
```
...
**Syntax**
```javascript
Div.set_formscrollbartrackbarsize(nSize) // set
Div.formscrollbartrackbarsize // get
```
...
**Syntax**
```javascript
Div.set_formscrollbartype(strBartype) // set
Div.formscrollbartype // get
```
...
- 데스크탑에 적용되는 값과 모바일에 적용되는 값을 함께 설정할 수 있지만 권장하지 않습니다.
   ex) this.Div00.set_formscrollbartype( "fixed autoindicator" ) ;
...
**Syntax**
```javascript
Div.set_formscrollindicatorsize(nSize) // set
Div.formscrollindicatorsize // get
```
...
**Syntax**
```javascript
Div.set_formscrolltype(enumType) // set
Div.formscrolltype // get
```

**Setting Syntax**
```javascript
Div 의 내부 Form 에서 수평 스크롤만 사용합니다.
...
**Syntax**
```javascript
Div.set_height(nHeight) // set
Div.height // get
```

**Setting Syntax**
```javascript
Div 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Div 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Div 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
Div.set_initvalueid(strValueID) // set
Div.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 Div 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Div.set_left(nLeft) // set
Div.left // get
```

**Setting Syntax**
```javascript
Div 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 Div 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Div 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 Div 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Div 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Div.set_letterSpacing(strspace) // set
Div.letterSpacing // get
```
...
**Syntax**
```javascript
Div.set_maxheight(nMaxHeight) // set
Div.maxheight // get
```

**Setting Syntax**
```javascript
Div 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Div.set_maxwidth(nMaxWidth) // set
Div.maxwidth // get
```

**Setting Syntax**
```javascript
Div 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Div.set_minheight(nMinHeight) // set
Div.minheight // get
```

**Setting Syntax**
```javascript
Div 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Div.set_minwidth(nMinWidth) // set
Div.minwidth // get
```

**Setting Syntax**
```javascript
Div 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Div.set_opacity(strOpacity) // set
Div.opacity // get
```
...
**Syntax**
```javascript
Div.set_positionstep(nStep) // set
Div.positionstep // get
```

**Setting Syntax**
```javascript
Div 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
Div.set_right(nRight) // set
Div.right // get
```

**Setting Syntax**
```javascript
Div 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 Div 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Div 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 Div 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Div 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
Div 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
Div.set_tablecellarea(strArea) // set
Div.tablecellarea // get
```
...
**Syntax**
```javascript
Div.set_taborder(nTabOrder) // set
Div.taborder // get
```
...
**Syntax**
```javascript
Div.set_tabstop(bTabStop) // set
Div.tabstop // get
```

**Setting Syntax**
```javascript
Div 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
Div.set_text(strText) // set
Div.text // get
```

**Setting Syntax**
```javascript
Div 에 연결된 Form이 없거나 내부 컴포넌트가 없을 때 화면에 표시될 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
Div.set_tooltiptext(strToolTipText) // set
Div.tooltiptext // get
```
...
**Syntax**
```javascript
Div.set_tooltiptype(enumTooltipType) // set
Div.tooltiptype // get
```

**Setting Syntax**
```javascript
Div 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
Div.set_top(nTop) // set
Div.top // get
```

**Setting Syntax**
```javascript
Div 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 Div 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Div 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 Div 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Div 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Div.set_urlchangeeffect(strEffect) // set
Div.urlchangeeffect // get
```

**Setting Syntax**
```javascript
Animation 효과가 적용되는 방향을 설정합니다.
...
**Syntax**
```javascript
Div.set_visible(bVisible) // set
Div.visible // get
```

**Setting Syntax**
```javascript
Div 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
Div.set_width(nWidth) // set
Div.width // get
```

**Setting Syntax**
```javascript
Div 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Div 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Div 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
Div.set_wordSpacing(strWordSpacing) // set
Div.wordSpacing // get
```
