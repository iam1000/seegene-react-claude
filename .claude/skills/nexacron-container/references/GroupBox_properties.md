...
| `accessibilityaction` | GroupBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 acti |
| `accessibilitydesclevel` | GroupBox 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | GroupBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 desc |
| `accessibilityenable` | GroupBox 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | GroupBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 labe |
...
**Syntax**
```javascript
GroupBox.set_border(strborder) // set
GroupBox.border // get
```
...
**Syntax**
```javascript
GroupBox.set_padding(strpadding) // set
GroupBox.padding // get
```

**Setting Syntax**
```javascript
GroupBox 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
GroupBox.set_accessibilityaction(strAction) // set
GroupBox.accessibilityaction // get
```
...
**Syntax**
```javascript
GroupBox.set_accessibilitydesclevel(enumLevel) // set
GroupBox.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
GroupBox 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
GroupBox.set_accessibilitydescription(strDescription) // set
GroupBox.accessibilitydescription // get
```
...
**Syntax**
```javascript
GroupBox.set_accessibilityenable(bEnable) // set
GroupBox.accessibilityenable // get
```

**Setting Syntax**
```javascript
GroupBox 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
GroupBox.set_accessibilitylabel(strLabel) // set
GroupBox.accessibilitylabel // get
```
...
**Syntax**
```javascript
GroupBox.set_accessibilityrole(enumRole) // set
GroupBox.accessibilityrole // get
```
...
**Syntax**
```javascript
GroupBox.set_background( strBackground ) // set 
GroupBox.background // get
```
...
**Syntax**
```javascript
GroupBox.set_borderRadius(strborderradius) // set
GroupBox.borderRadius // get
```
...
**Syntax**
```javascript
GroupBox.set_bottom(nBottom) // set
GroupBox.bottom // get
```

**Setting Syntax**
```javascript
GroupBox 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 GroupBox 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 GroupBox 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 GroupBox 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 GroupBox 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
GroupBox.set_boxShadow(strbshadow) // set
GroupBox.boxShadow // get
```
...
**Syntax**
```javascript
GroupBox.set_color(strcolor) // set
GroupBox.color // get
```
...
**Syntax**
```javascript
GroupBox.set_cssclass(strcssclass) // set
GroupBox.cssclass // get
```
...
**Syntax**
```javascript
GroupBox.set_cursor(strCursor) // set
GroupBox.cursor // get
```
...
**Syntax**
```javascript
GroupBox.set_enable(benable) // set
GroupBox.enable // get
```

**Setting Syntax**
```javascript
GroupBox 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
GroupBox.set_enableevent(bEvent) // set
GroupBox.enableevent // get
```

**Setting Syntax**
```javascript
GroupBox 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
GroupBox.set_flexgrow(fVal) // set
GroupBox.flexgrow // get
```
...
**Syntax**
```javascript
GroupBox.set_flexshrink(fVal) // set
GroupBox.flexshrink // get
```
...
**Syntax**
```javascript
GroupBox.set_height(nHeight) // set
GroupBox.height // get
```

**Setting Syntax**
```javascript
GroupBox 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 GroupBox 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 GroupBox 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
GroupBox.set_hotkey(strHotkey) // set
GroupBox.hotkey // get
```
...
**Syntax**
```javascript
GroupBox.set_initvalueid(strValueID) // set
GroupBox.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 GroupBox 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
GroupBox.set_layoutorder(nVal) // set
GroupBox.layoutorder // get
```
...
**Syntax**
```javascript
GroupBox.set_left(nLeft) // set
GroupBox.left // get
```

**Setting Syntax**
```javascript
GroupBox 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 GroupBox 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 GroupBox 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 GroupBox 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 GroupBox 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
GroupBox.set_letterSpacing(strspace) // set
GroupBox.letterSpacing // get
```
...
**Syntax**
```javascript
GroupBox.set_maxheight(nMaxHeight) // set
GroupBox.maxheight // get
```

**Setting Syntax**
```javascript
GroupBox 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
GroupBox.set_maxwidth(nMaxWidth) // set
GroupBox.maxwidth // get
```

**Setting Syntax**
```javascript
GroupBox 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
GroupBox.set_minheight(nMinHeight) // set
GroupBox.minheight // get
```

**Setting Syntax**
```javascript
GroupBox 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
GroupBox.set_minwidth(nMinWidth) // set
GroupBox.minwidth // get
```

**Setting Syntax**
```javascript
GroupBox 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
GroupBox.set_opacity(strOpacity) // set
GroupBox.opacity // get
```
...
**Syntax**
```javascript
GroupBox.set_positionstep(nStep) // set
GroupBox.positionstep // get
```

**Setting Syntax**
```javascript
GroupBox 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
GroupBox.set_right(nRight) // set
GroupBox.right // get
```

**Setting Syntax**
```javascript
GroupBox 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 GroupBox 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 GroupBox 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 GroupBox 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 GroupBox 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
GroupBox 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
GroupBox.set_tablecellarea(strArea) // set
GroupBox.tablecellarea // get
```
...
**Syntax**
```javascript
GroupBox.set_taborder(nTabOrder) // set
GroupBox.taborder // get
```
...
**Syntax**
```javascript
GroupBox.set_text(strText) // set
GroupBox.text // get
```

**Setting Syntax**
```javascript
GroupBox 에 타이틀로 표시될 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
GroupBox.set_titlealign(enumTitleAlign) // set
GroupBox.titlealign // get
```
...
**Syntax**
```javascript
GroupBox.set_titlegap(nGap) // set
GroupBox.titlegap // get
```

**Setting Syntax**
```javascript
titlealign 속성값에 따라 타이틀이 표시되는 위치의 간격을 pixel 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
GroupBox.set_tooltiptext(strToolTipText) // set
GroupBox.tooltiptext // get
```
...
**Syntax**
```javascript
GroupBox.set_tooltiptype(enumTooltipType) // set
GroupBox.tooltiptype // get
```

**Setting Syntax**
```javascript
GroupBox 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
GroupBox.set_top(nTop) // set
GroupBox.top // get
```

**Setting Syntax**
```javascript
GroupBox 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 GroupBox 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 GroupBox 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 GroupBox 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 GroupBox 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
GroupBox.set_visible(bVisible) // set
GroupBox.visible // get
```

**Setting Syntax**
```javascript
GroupBox 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
GroupBox.set_width(nWidth) // set
GroupBox.width // get
```

**Setting Syntax**
```javascript
GroupBox 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 GroupBox 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 GroupBox 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
GroupBox.set_wordSpacing(strWordSpacing) // set
GroupBox.wordSpacing // get
```
