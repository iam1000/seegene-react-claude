...
| `accessibilityaction` | View에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정 |
| `accessibilitydesclevel` | View 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | View에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 descript |
| `accessibilityenable` | View 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | View에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보 |
...
| `sourceview` | View 오브젝트에서 다른 View 오브젝트의 viewdataset을 사용하기 위해 View 오브젝트를 설정하는 속성입니다. |
...
| `viewdataset` | View 의 Model 정보를 가지는 DataSet 의 ID 를 갖는 읽기전용 속성입니다. |
...
**Syntax**
```javascript
View.set_accessibilityaction(strAction) // set
View.accessibilityaction // get
```
...
**Syntax**
```javascript
View.set_accessibilitydesclevel(enumLevel) // set
View.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
View 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
View.set_accessibilitydescription(strDescription) // set
View.accessibilitydescription // get
```
...
**Syntax**
```javascript
View.set_accessibilityenable(bEnable) // set
View.accessibilityenable // get
```

**Setting Syntax**
```javascript
View 에 선택상자가 이동되지 않습니다.
```
...
- 모바일 환경에서는 선택상자가 View 컴포넌트 자체가 아닌, View 컴포넌트 내부로 이동됩니다.
...
**Syntax**
```javascript
View.set_accessibilitylabel(strLabel) // set
View.accessibilitylabel // get
```
...
**Syntax**
```javascript
View.set_accessibilityrole(enumRole) // set
View.accessibilityrole // get
```
...
**Syntax**
```javascript
View.set_background( strBackground ) // set 
View.background // get
```
...
**Syntax**
```javascript
View.set_borderRadius(strborderradius) // set
View.borderRadius // get
```
...
**Syntax**
```javascript
View.set_bottom(nBottom) // set
View.bottom // get
```

**Setting Syntax**
```javascript
View 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 View 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 View 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 View 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 View 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
View.set_boxShadow(strbshadow) // set
View.boxShadow // get
```
...
**Syntax**
```javascript
View.set_cssclass(strcssclass) // set
View.cssclass // get
```
...
**Syntax**
```javascript
View.set_enable(benable) // set
View.enable // get
```

**Setting Syntax**
```javascript
View 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
View.set_enableevent(bEvent) // set
View.enableevent // get
```

**Setting Syntax**
```javascript
View 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
View.set_formscrollbarbarminsize(nSize) // set
View.formscrollbarbarminsize // get
```
...
**Syntax**
```javascript
View.set_formscrollbarbaroutsize(nSize) // set
View.formscrollbarbaroutsize // get
```
...
**Syntax**
```javascript
View.set_formscrollbardecbuttonsize(nSize) // set
View.formscrollbardecbuttonsize // get
```
...
**Syntax**
```javascript
View.set_formscrollbarincbuttonsize(nSize) // set
View.formscrollbarincbuttonsize // get
```
...
**Syntax**
```javascript
View.set_formscrollbarsize(nSize) // set
View.formscrollbarsize // get
```
...
**Syntax**
```javascript
View.set_formscrollbartrackbarsize(nSize) // set
View.formscrollbartrackbarsize // get
```
...
**Syntax**
```javascript
View.set_formscrollbartype(strBartype) // set
View.formscrollbartype // get
```
...
- 데스크탑에 적용되는 값과 모바일에 적용되는 값을 함께 설정할 수 있지만 권장하지 않습니다.
   ex) this.View00.set_formscrollbartype( "fixed autoindicator" ) ;
...
**Syntax**
```javascript
View.set_formscrollindicatorsize(nSize) // set
View.formscrollindicatorsize // get
```
...
**Syntax**
```javascript
View.set_formscrolltype(enumType) // set
View.formscrolltype // get
```

**Setting Syntax**
```javascript
View 의 내부 Form 에서 수평 스크롤만 사용합니다.
...
**Syntax**
```javascript
View.set_height(nHeight) // set
View.height // get
```

**Setting Syntax**
```javascript
View 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 View 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 View 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
View.set_initvalueid(strValueID) // set
View.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 View 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
View.set_layoutorder(nVal) // set
View.layoutorder // get
```
...
**Syntax**
```javascript
View.set_left(nLeft) // set
View.left // get
```

**Setting Syntax**
```javascript
View 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 View 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 View 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 View 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 View 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
View.set_letterSpacing(strspace) // set
View.letterSpacing // get
```
...
**Syntax**
```javascript
View.set_maxheight(nMaxHeight) // set
View.maxheight // get
```

**Setting Syntax**
```javascript
View 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
View.set_maxwidth(nMaxWidth) // set
View.maxwidth // get
```

**Setting Syntax**
```javascript
View 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
View.set_minheight(nMinHeight) // set
View.minheight // get
```

**Setting Syntax**
```javascript
View 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
View.set_minwidth(nMinWidth) // set
View.minwidth // get
```

**Setting Syntax**
```javascript
View 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
View.set_opacity(strOpacity) // set
View.opacity // get
```
...
**Syntax**
```javascript
View.set_positionstep(nStep) // set
View.positionstep // get
```

**Setting Syntax**
```javascript
View 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
View.set_right(nRight) // set
View.right // get
```

**Setting Syntax**
```javascript
View 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 View 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 View 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 View 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 View 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
View 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Setting Syntax**
```javascript
Generate 시 <div> 요소를 <footer> 요소로 대체합니다.
```
...
View 오브젝트에서 다른 View 오브젝트의 viewdataset을 사용하기 위해 View 오브젝트를 설정하는 속성입니다.

**Remark**
- 넥사크로 스튜디오에서만 값을 설정할 수 있고, 실행 중에는 수정할 수 없는 속성입니다.

- getViewDataset 메서드 실행 시 sourceview 속성값으로 설정한 View 오브젝트의 viewdataset을 반환합니다.
...
**Syntax**
```javascript
View.set_tablecellarea(strArea) // set
View.tablecellarea // get
```
...
**Syntax**
```javascript
View.set_taborder(nTabOrder) // set
View.taborder // get
```
...
**Syntax**
```javascript
View.set_tabstop(bTabStop) // set
View.tabstop // get
```

**Setting Syntax**
```javascript
View 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
View.set_text(strText) // set 
View.text // get
```

**Setting Syntax**
```javascript
View 에 연결된 Form이 없거나 내부 컴포넌트가 없을 때 화면에 표시될 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
View.set_tooltiptext(strToolTipText) // set
View.tooltiptext // get
```
...
**Syntax**
```javascript
View.set_tooltiptype(enumTooltipType) // set
View.tooltiptype // get
```

**Setting Syntax**
```javascript
View 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
View.set_top(nTop) // set
View.top // get
```

**Setting Syntax**
```javascript
View 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 View 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 View 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 View 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 View 의 상단 위치가 결정됩니다.
```
...
View 의 Model 정보를 가지는 DataSet 의 ID 를 갖는 읽기전용 속성입니다.

**Syntax**
```javascript
View.viewdataset // get
```

**Remark**
- 넥사크로 스튜디오에서 View Generation Wizard 실행 시 선택한 Model과 View Template에 따라 Model 정보를 가지는 Dataset 오브젝트를 생성하고 해당 정보를 viewdataset 속성으로 설정합니다.
...
**Syntax**
```javascript
View.set_visible(bVisible) // set
View.visible // get
```

**Setting Syntax**
```javascript
View 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
View.set_width(nWidth) // set
View.width // get
```

**Setting Syntax**
```javascript
View 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 View 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 View 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
View.set_wordSpacing(strWordSpacing) // set
View.wordSpacing // get
```
