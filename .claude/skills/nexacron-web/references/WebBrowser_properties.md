...
| `accessibilityaction` | WebBrowser에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 ac |
| `accessibilitydesclevel` | WebBrowser 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | WebBrowser에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 de |
| `accessibilityenable` | WebBrowser 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | WebBrowser에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 la |
...
**Syntax**
```javascript
WebBrowser.set_border(strborder) // set
WebBrowser.border // get
```
...
**Syntax**
```javascript
WebBrowser.set_accessibilityaction(strAction) // set
WebBrowser.accessibilityaction // get
```
...
**Syntax**
```javascript
WebBrowser.set_accessibilitydesclevel(enumLevel) // set
WebBrowser.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
WebBrowser 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
WebBrowser.set_accessibilitydescription(strDescription) // set
WebBrowser.accessibilitydescription // get
```
...
**Syntax**
```javascript
WebBrowser.set_accessibilityenable(bEnable) // set
WebBrowser.accessibilityenable // get
```

**Setting Syntax**
```javascript
WebBrowser 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
WebBrowser.set_accessibilitylabel(strLabel) // set
WebBrowser.accessibilitylabel // get
```
...
**Syntax**
```javascript
WebBrowser.set_accessibilityleavemessage(strMsg) // set
WebBrowser.accessibilityleavemessage // get
```
...
**Syntax**
```javascript
WebBrowser.set_accessibilityrole(enumRole) // set
WebBrowser.accessibilityrole // get
```
...
**Syntax**
```javascript
WebBrowser.set_bottom(nBottom) // set
WebBrowser.bottom // get
```

**Setting Syntax**
```javascript
WebBrowser 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 WebBrowser 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 WebBrowser 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 WebBrowser 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 WebBrowser 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
WebBrowser.set_cssclass(strcssclass) // set
WebBrowser.cssclass // get
```
...
**Syntax**
```javascript
WebBrowser.set_enable(benable) // set
WebBrowser.enable // get
```

**Setting Syntax**
```javascript
WebBrowser 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
WebBrowser.set_flexgrow(fVal) // set
WebBrowser.flexgrow // get
```
...
**Syntax**
```javascript
WebBrowser.set_flexshrink(fVal) // set
WebBrowser.flexshrink // get
```
...
**Syntax**
```javascript
WebBrowser.set_height(nHeight) // set
WebBrowser.height // get
```

**Setting Syntax**
```javascript
WebBrowser 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 WebBrowser 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 WebBrowser 의 높이가 결정됩니다.
```
...
**Setting Syntax**
```javascript
WebBrowser를 구별할 수 있는 유일값을 갖습니다.
```
...
**Syntax**
```javascript
WebBrowser.set_initvalueid(strValueID) // set
WebBrowser.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 WebBrowser 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
WebBrowser.set_layoutorder(nVal) // set
WebBrowser.layoutorder // get
```
...
**Syntax**
```javascript
WebBrowser.set_left(nLeft) // set
WebBrowser.left // get
```

**Setting Syntax**
```javascript
WebBrowser 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 WebBrowser 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 WebBrowser 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 WebBrowser 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 WebBrowser 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
WebBrowser.set_maxheight(nMaxHeight) // set
WebBrowser.maxheight // get
```

**Setting Syntax**
```javascript
WebBrowser 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
WebBrowser.set_maxwidth(nMaxWidth) // set
WebBrowser.maxwidth // get
```

**Setting Syntax**
```javascript
WebBrowser 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
WebBrowser.set_minheight(nMinHeight) // set
WebBrowser.minheight // get
```

**Setting Syntax**
```javascript
WebBrowser 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
WebBrowser.set_minwidth(nMinWidth) // set
WebBrowser.minwidth // get
```

**Setting Syntax**
```javascript
WebBrowser 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
WebBrowser.set_name(strName) // set
WebBrowser.name // get
```
...
**Syntax**
```javascript
WebBrowser.set_positionstep(nStep) // set
WebBrowser.positionstep // get
```

**Setting Syntax**
```javascript
WebBrowser 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
WebBrowser.set_right(nRight) // set
WebBrowser.right // get
```

**Setting Syntax**
```javascript
WebBrowser 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 WebBrowser 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 WebBrowser 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 WebBrowser 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 WebBrowser 의 우측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
WebBrowser.set_tablecellarea(strArea) // set
WebBrowser.tablecellarea // get
```
...
**Syntax**
```javascript
WebBrowser.set_taborder(nTabOrder) // set
WebBrowser.taborder // get
```
...
**Syntax**
```javascript
WebBrowser.set_tabstop(bTabStop) // set
WebBrowser.tabstop // get
```

**Setting Syntax**
```javascript
WebBrowser 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
WebBrowser.set_top(nTop) // set
WebBrowser.top // get
```

**Setting Syntax**
```javascript
WebBrowser 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 WebBrowser 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 WebBrowser 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 WebBrowser 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 WebBrowser 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
WebBrowser.set_visible(bVisible) // set
WebBrowser.visible // get
```

**Setting Syntax**
```javascript
WebBrowser 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
WebBrowser.set_width(nWidth) // set
WebBrowser.width // get
```

**Setting Syntax**
```javascript
WebBrowser 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 WebBrowser 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 WebBrowser 의 너비가 결정됩니다.
```
