...
| `accessibilityaction` | GridBandControl에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포 |
| `accessibilitydesclevel` | GridBandControl 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | GridBandControl에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포 |
| `accessibilityenable` | GridBandControl 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | GridBandControl에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포 |
...
**Syntax**
```javascript
GridBandControl.set_border(strborder) // set
GridBandControl.border // get
```
...
**Syntax**
```javascript
GridBandControl.set_edge(stredge) // set
GridBandControl.edge // get
```
...
**Syntax**
```javascript
GridBandControl.set_accessibilityaction(strAction) // set
GridBandControl.accessibilityaction // get
```
...
**Syntax**
```javascript
GridBandControl.set_accessibilitydesclevel(enumLevel) // set
GridBandControl.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
GridBandControl 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
GridBandControl.set_accessibilitydescription(strDescription) // set
GridBandControl.accessibilitydescription // get
```
...
**Syntax**
```javascript
GridBandControl.set_accessibilityenable(bEnable) // set
GridBandControl.accessibilityenable // get
```

**Setting Syntax**
```javascript
GridBandControl 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Status : XComponent 의 현재 상태가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 XComponent 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 XComponent 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
**Syntax**
```javascript
GridBandControl.set_accessibilitylabel(strLabel) // set
GridBandControl.accessibilitylabel // get
```
...
**Syntax**
```javascript
GridBandControl.set_accessibilityrole(enumRole) // set
GridBandControl.accessibilityrole // get
```
...
**Syntax**
```javascript
GridBandControl.set_background( strBackground ) // set 
GridBandControl.background // get
```
...
**Syntax**
```javascript
GridBandControl.set_borderRadius(strborderradius) // set
GridBandControl.borderRadius // get
```
...
**Syntax**
```javascript
GridBandControl.set_color(strcolor) // set
GridBandControl.color // get
```
...
**Syntax**
```javascript
GridBandControl.set_cssclass(strcssclass) // set
GridBandControl.cssclass // get
```
...
**Syntax**
```javascript
GridBandControl.set_cursor(strCursor) // set
GridBandControl.cursor // get
```
...
**Syntax**
```javascript
GridBandControl.set_font(strfont) // set
GridBandControl.font // get
```
...
**Syntax**
```javascript
GridBandControl.set_letterSpacing(strspace) // set
GridBandControl.letterSpacing // get
```
...
**Syntax**
```javascript
GridBandControl.set_opacity(strOpacity) // set
GridBandControl.opacity // get
```
...
**Syntax**
```javascript
GridBandControl.set_tooltiptext(strToolTipText) // set
GridBandControl.tooltiptext // get
```
...
**Syntax**
```javascript
GridBandControl.set_tooltiptype(enumTooltipType) // set
GridBandControl.tooltiptype // get
```

**Setting Syntax**
```javascript
GridBandControl 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
GridBandControl.set_wordSpacing(strWordSpacing) // set
GridBandControl.wordSpacing // get
```
