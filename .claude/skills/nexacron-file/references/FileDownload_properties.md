...
| `accessibilityaction` | FileDownload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할  |
| `accessibilitydesclevel` | FileDownload 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | FileDownload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할  |
| `accessibilityenable` | FileDownload 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | FileDownload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할  |
...
**Syntax**
```javascript
FileDownload.set_border(strborder) // set
FileDownload.border // get
```
...
**Syntax**
```javascript
FileDownload.set_edge(stredge) // set
FileDownload.edge // get
```
...
**Syntax**
```javascript
FileDownload.set_icon(strurl) // set
FileDownload.icon // get
```
...
**Syntax**
```javascript
FileDownload.set_iconPosition(striconpos) // set
FileDownload.iconPosition // get
```
...
**Syntax**
```javascript
FileDownload.set_padding(strpadding) // set
FileDownload.padding // get
```

**Setting Syntax**
```javascript
FileDownload 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
FileDownload.set_textAlign(strtextalign) // set
FileDownload.textAlign // get
```
...
**Syntax**
```javascript
FileDownload.set_textDecoration(strTxtDeco) // set
FileDownload.textDecoration // get
```
...
**Syntax**
```javascript
FileDownload.set_textPadding(strtextpadding) // set
FileDownload.textPadding // get
```
...
**Syntax**
```javascript
FileDownload.set_verticalAlign(strvertalign) // set
FileDownload.verticalAlign // get
```
...
**Syntax**
```javascript
FileDownload.set_wordWrap(strwordwrap) // set
FileDownload.wordWrap // get
```
...
**Syntax**
```javascript
FileDownload.set_accessibilityaction(strAction) // set
FileDownload.accessibilityaction // get
```
...
**Syntax**
```javascript
FileDownload.set_accessibilitydesclevel(enumLevel) // set
FileDownload.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
FileDownload 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
FileDownload.set_accessibilitydescription(strDescription) // set
FileDownload.accessibilitydescription // get
```
...
**Syntax**
```javascript
FileDownload.set_accessibilityenable(bEnable) // set
FileDownload.accessibilityenable // get
```

**Setting Syntax**
```javascript
FileDownload 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
FileDownload.set_accessibilitylabel(strLabel) // set
FileDownload.accessibilitylabel // get
```
...
**Syntax**
```javascript
FileDownload.set_accessibilityrole(enumRole) // set
FileDownload.accessibilityrole // get
```
...
**Syntax**
```javascript
FileDownload.set_background( strBackground ) // set 
FileDownload.background // get
```
...
**Syntax**
```javascript
FileDownload.set_borderRadius(strborderradius) // set
FileDownload.borderRadius // get
```
...
**Syntax**
```javascript
FileDownload.set_bottom(nBottom) // set
FileDownload.bottom // get
```

**Setting Syntax**
```javascript
FileDownload 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 FileDownload 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 FileDownload 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 FileDownload 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 FileDownload 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
FileDownload.set_boxShadow(strbshadow) // set
FileDownload.boxShadow // get
```
...
**Syntax**
```javascript
FileDownload.set_color(strcolor) // set
FileDownload.color // get
```
...
**Syntax**
```javascript
FileDownload.set_cssclass(strcssclass) // set
FileDownload.cssclass // get
```
...
**Syntax**
```javascript
FileDownload.set_cursor(strCursor) // set
FileDownload.cursor // get
```
...
**Syntax**
```javascript
FileDownload.set_downloadfilename(strFileName) // set
FileDownload.downloadfilename // get
```

**Setting Syntax**
```javascript
다운로드를 위한 파일선택창에 기본으로 표시될 파일명을 설정합니다.
...
**Syntax**
```javascript
FileDownload.set_downloadurl(strURL) // set
FileDownload.downloadurl // get
```

**Setting Syntax**
```javascript
다운로드 받을 파일의 경로와 파일명을 문자열로 설정합니다.
```
...
**Syntax**
```javascript
FileDownload.set_enable(benable) // set
FileDownload.enable // get
```

**Setting Syntax**
```javascript
FileDownload 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
FileDownload.set_enableevent(bEvent) // set
FileDownload.enableevent // get
```

**Setting Syntax**
```javascript
FileDownload 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
FileDownload.set_expr(strExpr) // set
FileDownload.expr // get
```
...
**Remark**
- 동적으로 FileDownload 에 적용된 텍스트는 getDisplayText() 메소드를 사용하여 확인할 수 있습니다.
...
**Syntax**
```javascript
FileDownload.set_filefilter(strFileFilter) // set
FileDownload.filefilter // get
```
...
**Syntax**
```javascript
FileDownload.set_filefilterindex(nIndex) // set
...
**Syntax**
```javascript
FileDownload.set_fittocontents(enumFitTo) // set
FileDownload.fittocontents // get
```

**Setting Syntax**
```javascript
컨텐츠 내용에 맞게 FileDownload 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.
```
...
**Syntax**
```javascript
FileDownload.set_flexgrow(fVal) // set
FileDownload.flexgrow // get
```
...
**Syntax**
```javascript
FileDownload.set_flexshrink(fVal) // set
FileDownload.flexshrink // get
```
...
**Syntax**
```javascript
FileDownload.set_font(strfont) // set
FileDownload.font // get
```
...
**Syntax**
```javascript
FileDownload.set_height(nHeight) // set
FileDownload.height // get
```

**Setting Syntax**
```javascript
FileDownload 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 FileDownload 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 FileDownload 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
FileDownload.set_hotkey(strHotkey) // set
FileDownload.hotkey // get
```
...
**Setting Syntax**
```javascript
FileDownload를 구별할 수 있는 유일값을 갖습니다.
```
...
**Syntax**
```javascript
FileDownload.set_layoutorder(nVal) // set
FileDownload.layoutorder // get
```
...
**Syntax**
```javascript
FileDownload.set_left(nLeft) // set
FileDownload.left // get
```

**Setting Syntax**
```javascript
FileDownload 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 FileDownload 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 FileDownload 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 FileDownload 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 FileDownload 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
FileDownload.set_letterSpacing(strspace) // set
FileDownload.letterSpacing // get
```
...
**Syntax**
```javascript
FileDownload.set_maxheight(nMaxHeight) // set
FileDownload.maxheight // get
```

**Setting Syntax**
```javascript
FileDownload 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FileDownload.set_maxwidth(nMaxWidth) // set
FileDownload.maxwidth // get
```

**Setting Syntax**
```javascript
FileDownload 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FileDownload.set_minheight(nMinHeight) // set
FileDownload.minheight // get
```

**Setting Syntax**
```javascript
FileDownload 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FileDownload.set_minwidth(nMinWidth) // set
FileDownload.minwidth // get
```

**Setting Syntax**
```javascript
FileDownload 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FileDownload.set_name(strName) // set
FileDownload.name // get
```
...
**Syntax**
```javascript
FileDownload.set_opacity(strOpacity) // set
FileDownload.opacity // get
```
...
**Syntax**
```javascript
FileDownload.set_positionstep(nStep) // set
FileDownload.positionstep // get
```

**Setting Syntax**
```javascript
FileDownload 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
FileDownload.set_right(nRight) // set
FileDownload.right // get
```

**Setting Syntax**
```javascript
FileDownload 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 FileDownload 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 FileDownload 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 FileDownload 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 FileDownload 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
FileDownload 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
FileDownload.set_tablecellarea(strArea) // set
FileDownload.tablecellarea // get
```
...
**Syntax**
```javascript
FileDownload.set_taborder(nTabOrder) // set
FileDownload.taborder // get
```
...
**Syntax**
```javascript
FileDownload.set_tabstop(bTabStop) // set
FileDownload.tabstop // get
```

**Setting Syntax**
```javascript
FileDownload 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
FileDownload.set_text(strText) // set
FileDownload.text // get
```

**Setting Syntax**
```javascript
FileDownload 에 표시될 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
FileDownload.set_tooltiptext(strToolTipText) // set
FileDownload.tooltiptext // get
```
...
**Syntax**
```javascript
FileDownload.set_tooltiptype(enumTooltipType) // set
FileDownload.tooltiptype // get
```

**Setting Syntax**
```javascript
FileDownload 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
FileDownload.set_top(nTop) // set
FileDownload.top // get
```

**Setting Syntax**
```javascript
FileDownload 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 FileDownload 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 FileDownload 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 FileDownload 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 FileDownload 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
FileDownload.set_visible(bVisible) // set
FileDownload.visible // get
```

**Setting Syntax**
```javascript
FileDownload 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
FileDownload.set_width(nWidth) // set
FileDownload.width // get
```

**Setting Syntax**
```javascript
FileDownload 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 FileDownload 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 FileDownload 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
FileDownload.set_wordSpacing(strWordSpacing) // set
FileDownload.wordSpacing // get
```
