...
| `accessibilityaction` | FileUpload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 ac |
| `accessibilitydesclevel` | FileUpload 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | FileUpload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 de |
| `accessibilityenable` | FileUpload 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | FileUpload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 la |
...
**Syntax**
```javascript
FileUpload.set_border(strborder) // set
FileUpload.border // get
```
...
**Syntax**
```javascript
FileUpload.set_edge(stredge) // set
FileUpload.edge // get
```
...
**Syntax**
```javascript
FileUpload.set_padding(strpadding) // set
FileUpload.padding // get
```

**Setting Syntax**
```javascript
FileUpload 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
FileUpload.set_accessibilityaction(strAction) // set
FileUpload.accessibilityaction // get
```
...
**Syntax**
```javascript
FileUpload.set_accessibilitydesclevel(enumLevel) // set
FileUpload.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
FileUpload 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
FileUpload.set_accessibilitydescription(strDescription) // set
FileUpload.accessibilitydescription // get
```
...
**Syntax**
```javascript
FileUpload.set_accessibilityenable(bEnable) // set
FileUpload.accessibilityenable // get
```

**Setting Syntax**
```javascript
FileUpload 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
FileUpload.set_accessibilitylabel(strLabel) // set
FileUpload.accessibilitylabel // get
```
...
**Syntax**
```javascript
FileUpload.set_accessibilityrole(enumRole) // set
FileUpload.accessibilityrole // get
```
...
**Syntax**
```javascript
FileUpload.set_background( strBackground ) // set 
FileUpload.background // get
```
...
**Syntax**
```javascript
FileUpload.set_borderRadius(strborderradius) // set
FileUpload.borderRadius // get
```
...
**Syntax**
```javascript
FileUpload.set_bottom(nBottom) // set
FileUpload.bottom // get
```

**Setting Syntax**
```javascript
FileUpload 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 FileUpload 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 FileUpload 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 FileUpload 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 FileUpload 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
FileUpload.set_boxShadow(strbshadow) // set
FileUpload.boxShadow // get
```
...
**Syntax**
```javascript
FileUpload.set_buttonsize(nButtonSize) // set
FileUpload.buttonsize // get
```

**Setting Syntax**
```javascript
파일찾기버튼(fileuploaditembutton)의 가로 크기를 pixel 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
FileUpload.set_buttontext(strText) // set
FileUpload.buttontext // get
```

**Setting Syntax**
```javascript
파일찾기버튼(fileitembutton)에 표시될 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_color(strcolor) // set
FileUpload.color // get
```
...
**Syntax**
```javascript
FileUpload.set_cssclass(strcssclass) // set
FileUpload.cssclass // get
```
...
**Syntax**
```javascript
FileUpload.set_cursor(strCursor) // set
FileUpload.cursor // get
```
...
**Syntax**
```javascript
FileUpload.set_enable(benable) // set
FileUpload.enable // get
```

**Setting Syntax**
```javascript
FileUpload 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
FileUpload.set_enableevent(bEvent) // set
FileUpload.enableevent // get
```

**Setting Syntax**
```javascript
FileUpload 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_filefilter(strFileFilter) // set
FileUpload.filefilter // get
```
...
**Syntax**
```javascript
FileUpload.set_filefilterindex(nIndex) // set
FileUpload.filefilterindex // get
```
...
**Syntax**
```javascript
FileUpload.set_flexgrow(fVal) // set
FileUpload.flexgrow // get
```
...
**Syntax**
```javascript
FileUpload.set_flexshrink(fVal) // set
FileUpload.flexshrink // get
```
...
**Syntax**
```javascript
FileUpload.set_font(strfont) // set
FileUpload.font // get
```
...
**Syntax**
```javascript
FileUpload.set_height(nHeight) // set
FileUpload.height // get
```

**Setting Syntax**
```javascript
FileUpload 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 FileUpload 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 FileUpload 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
FileUpload.set_hotkey(strHotkey) // set
FileUpload.hotkey // get
```
...
**Setting Syntax**
```javascript
FileUpload를 구별할 수 있는 유일값을 갖습니다.
```
...
**Syntax**
```javascript
FileUpload.set_index(nIndex) // set
FileUpload.index // get
```
...
**Syntax**
```javascript
FileUpload.set_initvalueid(strValueID) // set
FileUpload.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 FileUpload 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_itemcount(nItemcount) // set
FileUpload.itemcount // get
```

**Setting Syntax**
```javascript
화면에 표시될 아이템의 갯수를 0 이상의 정수로 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_itemheight(nHeight) // set
FileUpload.itemheight // get
```

**Setting Syntax**
```javascript
아이템 영역의 높이를 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_layoutorder(nVal) // set
FileUpload.layoutorder // get
```
...
**Syntax**
```javascript
FileUpload.set_left(nLeft) // set
FileUpload.left // get
```

**Setting Syntax**
```javascript
FileUpload 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 FileUpload 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 FileUpload 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 FileUpload 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 FileUpload 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
FileUpload.set_letterSpacing(strspace) // set
FileUpload.letterSpacing // get
```
...
**Syntax**
```javascript
FileUpload.set_maxheight(nMaxHeight) // set
FileUpload.maxheight // get
```

**Setting Syntax**
```javascript
FileUpload 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_maxwidth(nMaxWidth) // set
FileUpload.maxwidth // get
```

**Setting Syntax**
```javascript
FileUpload 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_minheight(nMinHeight) // set
FileUpload.minheight // get
```

**Setting Syntax**
```javascript
FileUpload 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_minwidth(nMinWidth) // set
FileUpload.minwidth // get
```

**Setting Syntax**
```javascript
FileUpload 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_multiselect(bMultiselect) // set
FileUpload.multiselect // get
```

**Setting Syntax**
```javascript
파일 선택창에서 한개의 파일만 선택할 수 있습니다.
```
...
**Syntax**
```javascript
FileUpload.set_name(strName) // set
FileUpload.name // get
```
...
**Syntax**
```javascript
FileUpload.set_opacity(strOpacity) // set
FileUpload.opacity // get
```
...
**Syntax**
```javascript
FileUpload.set_positionstep(nStep) // set
FileUpload.positionstep // get
```

**Setting Syntax**
```javascript
FileUpload 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
FileUpload.set_right(nRight) // set
FileUpload.right // get
```

**Setting Syntax**
```javascript
FileUpload 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 FileUpload 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 FileUpload 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 FileUpload 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 FileUpload 의 우측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
FileUpload.set_scrollbarbarminsize( nSize ) // set 
FileUpload.scrollbarbarminsize // get
```
...
**Syntax**
```javascript
FileUpload.set_scrollbarbaroutsize( nSize ) // set 
FileUpload.scrollbarbaroutsize // get
```
...
**Syntax**
```javascript
FileUpload.set_scrollbardecbuttonsize(nHeight) // set
FileUpload.scrollbardecbuttonsize // get
```
...
**Syntax**
```javascript
FileUpload.set_scrollbarincbuttonsize(nHeight) // set
FileUpload.scrollbarincbuttonsize // get
```

**Setting Syntax**
```javascript
스크롤바의 증가버튼(IncButton) 높이를 pixel 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
FileUpload.set_scrollbarsize(nWidth) // set
FileUpload.scrollbarsize // get
```
...
**Syntax**
```javascript
FileUpload.set_scrollbartrackbarsize( nSize ) // set 
FileUpload.scrollbartrackbarsize // get
```
...
**Syntax**
```javascript
FileUpload.set_scrollbartype(strBartype) // set
FileUpload.scrollbartype // get
```
...
**Syntax**
```javascript
FileUpload.set_scrollindicatorsize(nSize) // set
FileUpload.scrollindicatorsize // get
```
...
**Syntax**
```javascript
FileUpload.set_scrolltype(enumType) // set
FileUpload.scrolltype // get
```

**Setting Syntax**
```javascript
FileUpload 에서 수평 스크롤만 사용합니다.
...
**Syntax**
```javascript
FileUpload.set_tablecellarea(strArea) // set
FileUpload.tablecellarea // get
```
...
**Syntax**
```javascript
FileUpload.set_taborder(nTabOrder) // set
FileUpload.taborder // get
```
...
**Syntax**
```javascript
FileUpload.set_tabstop(bTabStop) // set
FileUpload.tabstop // get
```

**Setting Syntax**
```javascript
FileUpload 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
- IE 외의 브라우저에서 팝업으로 표시된 파일선택창의 "취소" 버튼을 클릭하면 이미 선택되어 있던 파일정보가 지워집니다.
...
**Syntax**
```javascript
FileUpload.set_tooltiptext(strToolTipText) // set
FileUpload.tooltiptext // get
```
...
**Syntax**
```javascript
FileUpload.set_tooltiptype(enumTooltipType) // set
FileUpload.tooltiptype // get
```

**Setting Syntax**
```javascript
FileUpload 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
FileUpload.set_top(nTop) // set
FileUpload.top // get
```

**Setting Syntax**
```javascript
FileUpload 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 FileUpload 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 FileUpload 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 FileUpload 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 FileUpload 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
FileUpload.set_uploadurl(strURL) // set
FileUpload.uploadurl // get
```

**Setting Syntax**
```javascript
업로드 파일을 수신 할 서버페이지 정보를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
FileUpload.set_visible(bVisible) // set
FileUpload.visible // get
```

**Setting Syntax**
```javascript
FileUpload 을(를) 화면에 표시하지 않습니다.
```
...
**Setting Syntax**
```javascript
this.FileUpload00.vscrollbar.set_decbuttonsize( 30 );
```
...
**Syntax**
```javascript
FileUpload.set_width(nWidth) // set
FileUpload.width // get
```

**Setting Syntax**
```javascript
FileUpload 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 FileUpload 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 FileUpload 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
FileUpload.set_wordSpacing(strWordSpacing) // set
FileUpload.wordSpacing // get
```
