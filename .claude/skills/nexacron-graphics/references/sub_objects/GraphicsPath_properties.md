...
**Syntax**
```javascript
GraphicsPath.set_fillstyle(strFillStyle) // set
GraphicsPath.fillstyle // get
```
...
**Syntax**
```javascript
GraphicsPath.set_miterlimit(nLimit) // set
GraphicsPath.miterlimit // get
```
...
**Syntax**
```javascript
GraphicsPath.set_opacity(nOpacity) // set
GraphicsPath.opacity // get
```
...
**Syntax**
```javascript
GraphicsPath.set_strokecap(enumCap) // set
GraphicsPath.strokecap // get
```
...
**Syntax**
```javascript
GraphicsPath.set_strokejoin(enumJoin) // set
GraphicsPath.strokejoin // get
```
...
**Syntax**
```javascript
GraphicsPath.set_strokepen(strStrokePen) // set
GraphicsPath.strokepen // get
```
...
**Syntax**
```javascript
GraphicsPath.set_visible(bVisible) // set
GraphicsPath.visible // get
```
