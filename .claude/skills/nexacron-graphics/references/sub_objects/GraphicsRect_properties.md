...
**Syntax**
```javascript
GraphicsRect.set_fillstyle(strFillStyle) // set
GraphicsRect.fillstyle // get
```
...
**Syntax**
```javascript
GraphicsRect.set_height(nHeight) // set
GraphicsRect.height // get
```

**Setting Syntax**
```javascript
GraphicsRect 영역의 높이를 pixel 단위의 숫자로 설정합니다.
...
**Setting Syntax**
```javascript
GraphicsRect 를 구별할 수 있는 유일값을 설정합니다.
```
...
**Syntax**
```javascript
GraphicsRect.set_miterlimit(nLimit) // set
GraphicsRect.miterlimit // get
```
...
**Syntax**
```javascript
GraphicsRect.set_opacity(nOpacity) // set
GraphicsRect.opacity // get
```
...
**Syntax**
```javascript
GraphicsRect.set_radiusx(nRadiusx) // set
GraphicsRect.radiusx // get
```

**Setting Syntax**
```javascript
모서리를 둥글게 표시하기 위한 x 축의 반경을 pixel 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
GraphicsRect.set_radiusy(nRadiusy) // set
GraphicsRect.radiusy // get
```

**Setting Syntax**
```javascript
모서리를 둥글게 표시하기 위한 y 축의 반경을  pixel 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
GraphicsRect.set_strokejoin(enumJoin) // set
GraphicsRect.strokejoin // get
```

**Setting Syntax**
```javascript
모서리 끝부분이 45도 각도로 잘린것처럼 표시됩니다.
```
...
**Syntax**
```javascript
GraphicsRect.set_strokepen(strStrokePen) // set
GraphicsRect.strokepen // get
```
...
**Syntax**
```javascript
GraphicsRect.set_visible(bVisible) // set
GraphicsRect.visible // get
```

**Setting Syntax**
```javascript
Graphics 컴포넌트의 redraw() 메소드 수행 시 GraphicsRect 를 표시하지 않습니다.
```
...
**Syntax**
```javascript
GraphicsRect.set_width(nWidth) // set
GraphicsRect.width // get
```

**Setting Syntax**
```javascript
GraphicsRect 영역의 너비를 pixel 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
GraphicsRect.set_x(nX) // set
GraphicsRect.x // get
```

**Setting Syntax**
```javascript
부모 오브젝트를 기준으로 GraphicsRect 가 표시될 x 축 좌표값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
GraphicsRect.set_y(nY) // set
GraphicsRect.y // get
```

**Setting Syntax**
```javascript
부모 오브젝트를 기준으로 GraphicsRect 가 표시될 y 축 좌표값을 pixel 단위의 숫자로 설정합니다.
```
