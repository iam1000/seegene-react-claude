...
**Syntax**
```javascript
HFrameSet.set_border(strborder) // set
HFrameSet.border // get
```
...
**Syntax**
```javascript
HFrameSet.set_edge(stredge) // set
HFrameSet.edge // get
```
...
**Syntax**
```javascript
HFrameSet.set_background( strBackground ) // set 
HFrameSet.background // get
```
...
**Syntax**
```javascript
HFrameSet.set_borderRadius(strborderradius) // set
HFrameSet.borderRadius // get
```
...
**Syntax**
```javascript
HFrameSet.set_bottom(nBottom) // set
HFrameSet.bottom // get
```

**Setting Syntax**
```javascript
HFrameSet 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
HFrameSet.set_color(strcolor) // set
HFrameSet.color // get
```
...
**Syntax**
```javascript
HFrameSet.set_cssclass(strcssclass) // set
HFrameSet.cssclass // get
```
...
**Syntax**
```javascript
HFrameSet.set_cursor(strCursor) // set
HFrameSet.cursor // get
```
...
**Syntax**
```javascript
HFrameSet.set_enable(benable) // set
HFrameSet.enable // get
```

**Setting Syntax**
```javascript
HFrameSet 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
HFrameSet.set_enableevent(bEvent) // set
HFrameSet.enableevent // get
```

**Setting Syntax**
```javascript
HFrameSet 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
HFrameSet.set_font(strfont) // set
HFrameSet.font // get
```
...
**Syntax**
```javascript
HFrameSet.set_height(nHeight) // set
HFrameSet.height // get
```

**Setting Syntax**
```javascript
HFrameSet 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
HFrameSet.set_hotkey(strHotkey) // set
HFrameSet.hotkey // get
```
...
**Syntax**
```javascript
HFrameSet.set_left(nLeft) // set
HFrameSet.left // get
```

**Setting Syntax**
```javascript
HFrameSet 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
HFrameSet.set_name(strName) // set
HFrameSet.name // get
```
...
**Syntax**
```javascript
HFrameSet.set_opacity(strOpacity) // set
HFrameSet.opacity // get
```
...
**Syntax**
```javascript
HFrameSet.set_progressbardirection(enumDirection) // set
HFrameSet.progressbardirection // get
```
...
**Syntax**
```javascript
HFrameSet.set_progressbargap(nSize) // set
HFrameSet.progressbargap // get
```
...
**Syntax**
```javascript
HFrameSet.set_progressbarsize(nSize) // set
HFrameSet.progressbarsize // get
```
...
**Syntax**
```javascript
HFrameSet.set_progressbarsmooth(bSmooth) // set
HFrameSet.progressbarsmooth // get
```
...
**Syntax**
```javascript
HFrameSet.set_right(nRight) // set
HFrameSet.right // get
```

**Setting Syntax**
```javascript
HFrameSet 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
HFrameSet.set_separatesize(strSize) // set
HFrameSet.separatesize // get
```

**Setting Syntax**
```javascript
각 자식 Frame 별로 표시될 너비를 콤마(",")로 구분하여 설정합니다.
...
**Syntax**
```javascript
HFrameSet.set_showcascadestatustext(bShow) // set
HFrameSet.showcascadestatustext // get
```

**Setting Syntax**
```javascript
HFrameSet 의 statustext 속성값만 표시합니다.
```
...
**Syntax**
```javascript
HFrameSet.set_showcascadetitletext(bShow) // set
HFrameSet.showcascadetitletext // get
```

**Setting Syntax**
```javascript
HFrameSet 의 titletext 속성값만 표시합니다.
```
...
**Syntax**
```javascript
HFrameSet.set_showstatusbar(bshowstatus) // set
HFrameSet.showstatusbar // get
```

**Setting Syntax**
```javascript
HFrameSet 에 StatusBar 를 표시하지 않습니다.
```
...
**Syntax**
```javascript
HFrameSet.set_showtitlebar(bshowtitlebar) // set
HFrameSet.showtitlebar // get
```

**Setting Syntax**
```javascript
HFrameSet 에 TitleBar 를 표시하지 않습니다.
```
...
**Syntax**
```javascript
HFrameSet.set_showtitleicon(bshowtitleicon) // set
HFrameSet.showtitleicon // get
```

**Setting Syntax**
```javascript
HFrameSet 의 타이틀바에 아이콘을 표시하지 않습니다.
```
...
**Syntax**
```javascript
HFrameSet.set_statusbarheight(nHeight) // set
HFrameSet.statusbarheight // get
```
...
**Syntax**
```javascript
HFrameSet.set_statustext(strStatustext) // set
HFrameSet.statustext // get
```
...
**Syntax**
```javascript
HFrameSet.set_titlebarbuttongap(nGap) // set
HFrameSet.titlebarbuttongap // get
```
...
**Syntax**
```javascript
HFrameSet.set_titlebarbuttonsize(strSize) // set
HFrameSet.titlebarbuttonsize // get
```
...
**Syntax**
```javascript
HFrameSet.set_titlebarheight(nHeight) // set
HFrameSet.titlebarheight // get
```

**Setting Syntax**
```javascript
HFrameSet 의 TitleBar 높이를 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
HFrameSet.set_titletext(strTitletext) // set
HFrameSet.titletext // get
```
...
**Syntax**
```javascript
HFrameSet.set_top(nTop) // set
HFrameSet.top // get
```

**Setting Syntax**
```javascript
HFrameSet 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
HFrameSet.set_visible(bVisible) // set
HFrameSet.visible // get
```

**Setting Syntax**
```javascript
HFrameSet 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
HFrameSet.set_width(nWidth) // set
HFrameSet.width // get
```

**Setting Syntax**
```javascript
HFrameSet 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
