...
**Syntax**
```javascript
VFrameSet.set_border(strborder) // set
VFrameSet.border // get
```
...
**Syntax**
```javascript
VFrameSet.set_edge(stredge) // set
VFrameSet.edge // get
```
...
**Syntax**
```javascript
VFrameSet.set_background( strBackground ) // set 
VFrameSet.background // get
```
...
**Syntax**
```javascript
VFrameSet.set_borderRadius(strborderradius) // set
VFrameSet.borderRadius // get
```
...
**Syntax**
```javascript
VFrameSet.set_bottom(nBottom) // set
VFrameSet.bottom // get
```

**Setting Syntax**
```javascript
VFrameSet 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_color(strcolor) // set
VFrameSet.color // get
```
...
**Syntax**
```javascript
VFrameSet.set_cssclass(strcssclass) // set
VFrameSet.cssclass // get
```
...
**Syntax**
```javascript
VFrameSet.set_cursor(strCursor) // set
VFrameSet.cursor // get
```
...
**Syntax**
```javascript
VFrameSet.set_enable(benable) // set
VFrameSet.enable // get
```

**Setting Syntax**
```javascript
VFrameSet 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
VFrameSet.set_enableevent(bEvent) // set
VFrameSet.enableevent // get
```

**Setting Syntax**
```javascript
VFrameSet 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_font(strfont) // set
VFrameSet.font // get
```
...
**Syntax**
```javascript
VFrameSet.set_height(nHeight) // set
VFrameSet.height // get
```

**Setting Syntax**
```javascript
VFrameSet 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_hotkey(strHotkey) // set
VFrameSet.hotkey // get
```
...
**Syntax**
```javascript
VFrameSet.set_initvalueid(strValueID) // set
VFrameSet.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 VFrameSet 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_left(nLeft) // set
VFrameSet.left // get
```

**Setting Syntax**
```javascript
VFrameSet 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_letterSpacing(strspace) // set
VFrameSet.letterSpacing // get
```
...
**Syntax**
```javascript
VFrameSet.set_name(strName) // set
VFrameSet.name // get
```
...
**Syntax**
```javascript
VFrameSet.set_opacity(strOpacity) // set
VFrameSet.opacity // get
```
...
**Syntax**
```javascript
VFrameSet.set_progressbardirection(enumDirection) // set
VFrameSet.progressbardirection // get
```
...
**Syntax**
```javascript
VFrameSet.set_progressbargap(nSize) // set
VFrameSet.progressbargap // get
```
...
**Syntax**
```javascript
VFrameSet.set_progressbarsize(nSize) // set
VFrameSet.progressbarsize // get
```
...
**Syntax**
```javascript
VFrameSet.set_progressbarsmooth(bSmooth) // set
VFrameSet.progressbarsmooth // get
```
...
**Syntax**
```javascript
VFrameSet.set_right(nRight) // set
VFrameSet.right // get
```

**Setting Syntax**
```javascript
VFrameSet 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_separatesize(strSize) // set
VFrameSet.separatesize // get
```

**Setting Syntax**
```javascript
각 자식 Frame 별로 표시될 높이를 콤마(",")로 구분하여 설정합니다.
...
**Syntax**
```javascript
VFrameSet.set_showcascadestatustext(bShow) // set
VFrameSet.showcascadestatustext // get
```

**Setting Syntax**
```javascript
VFrameSet 의 statustext 속성값만 표시합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_showcascadetitletext(bShow) // set
VFrameSet.showcascadetitletext // get
```

**Setting Syntax**
```javascript
VFrameSet 의 titletext 속성값만 표시합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_showstatusbar(bshowstatus) // set
VFrameSet.showstatusbar // get
```

**Setting Syntax**
```javascript
VFrameSet 에 StatusBar 를 표시하지 않습니다.
```
...
**Syntax**
```javascript
VFrameSet.set_showtitlebar(bshowtitlebar) // set
VFrameSet.showtitlebar // get
```

**Setting Syntax**
```javascript
VFrameSet 에 TitleBar 를 표시하지 않습니다.
```
...
**Syntax**
```javascript
VFrameSet.set_showtitleicon(bshowtitleicon) // set
VFrameSet.showtitleicon // get
```

**Setting Syntax**
```javascript
VFrameSet 의 타이틀바에 아이콘을 표시하지 않습니다.
```
...
**Syntax**
```javascript
VFrameSet.set_statusbarheight(nHeight) // set
VFrameSet.statusbarheight // get
```
...
**Syntax**
```javascript
VFrameSet.set_statustext(strStatustext) // set
VFrameSet.statustext // get
```
...
**Syntax**
```javascript
VFrameSet.set_titlebarbuttongap(nGap) // set
VFrameSet.titlebarbuttongap // get
```
...
**Syntax**
```javascript
VFrameSet.set_titlebarbuttonsize(strSize) // set
VFrameSet.titlebarbuttonsize // get
```
...
**Syntax**
```javascript
VFrameSet.set_titlebarheight(nHeight) // set
VFrameSet.titlebarheight // get
```

**Setting Syntax**
```javascript
VFrameSet 의 TitleBar 높이를 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_titletext(strTitletext) // set
VFrameSet.titletext // get
```
...
**Syntax**
```javascript
VFrameSet.set_top(nTop) // set
VFrameSet.top // get
```

**Setting Syntax**
```javascript
VFrameSet 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_visible(bVisible) // set
VFrameSet.visible // get
```

**Setting Syntax**
```javascript
VFrameSet 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
VFrameSet.set_width(nWidth) // set
VFrameSet.width // get
```

**Setting Syntax**
```javascript
VFrameSet 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
VFrameSet.set_wordSpacing(strWordSpacing) // set
VFrameSet.wordSpacing // get
```
