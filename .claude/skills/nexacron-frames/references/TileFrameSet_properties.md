...
**Syntax**
```javascript
TileFrameSet.set_border(strborder) // set
TileFrameSet.border // get
```
...
**Syntax**
```javascript
TileFrameSet.set_edge(stredge) // set
TileFrameSet.edge // get
```
...
**Syntax**
```javascript
TileFrameSet.set_background( strBackground ) // set 
TileFrameSet.background // get
```
...
**Syntax**
```javascript
TileFrameSet.set_borderRadius(strborderradius) // set
TileFrameSet.borderRadius // get
```
...
**Syntax**
```javascript
TileFrameSet.set_bottom(nBottom) // set
TileFrameSet.bottom // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_color(strcolor) // set
TileFrameSet.color // get
```
...
**Syntax**
```javascript
TileFrameSet.set_cssclass(strcssclass) // set
TileFrameSet.cssclass // get
```
...
**Syntax**
```javascript
TileFrameSet.set_cursor(strCursor) // set
TileFrameSet.cursor // get
```
...
**Syntax**
```javascript
TileFrameSet.set_enable(benable) // set
TileFrameSet.enable // get
```

**Setting Syntax**
```javascript
TileFrameSet 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
TileFrameSet.set_enableevent(bEvent) // set
TileFrameSet.enableevent // get
```

**Setting Syntax**
```javascript
TileFrameSet 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_font(strfont) // set
TileFrameSet.font // get
```
...
**Syntax**
```javascript
TileFrameSet.set_fullframemaximize(bFullframe) // set
TileFrameSet.fullframemaximize // get
```

**Setting Syntax**
```javascript
TileFrameSet 하단에 최소화된 Frame 표시영역까지 자식 Frame 이 확대되지 않습니다.
...
**Syntax**
```javascript
TileFrameSet.set_height(nHeight) // set
TileFrameSet.height // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_hotkey(strHotkey) // set
TileFrameSet.hotkey // get
```
...
**Setting Syntax**
```javascript
TileFrameSet를 구별할 수 있는 유일값을 갖습니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_initvalueid(strValueID) // set
TileFrameSet.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 TileFrameSet 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_left(nLeft) // set
TileFrameSet.left // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_letterSpacing(strspace) // set
TileFrameSet.letterSpacing // get
```
...
**Syntax**
```javascript
TileFrameSet.set_minimizedchildposition(enumPos) // set
TileFrameSet.minimizedchildposition // get
```

**Setting Syntax**
```javascript
최소화 된 자식 Frame 이 TileFrameSet 내부의 아랫쪽 영역에 표시됩니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_minimizeheight(nHeight) // set
TileFrameSet.minimizeheight // get
```

**Setting Syntax**
```javascript
최소화 된 자식 Frame 의 높이를 pixel 단위로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_minimizewidth(nWidth) // set
TileFrameSet.minimizewidth // get
```

**Setting Syntax**
```javascript
최소화 된 자식 Frame 의 너비를 pixel 단위로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_name(strName) // set
TileFrameSet.name // get
```
...
**Syntax**
```javascript
TileFrameSet.set_opacity(strOpacity) // set
TileFrameSet.opacity // get
```
...
**Syntax**
```javascript
TileFrameSet.set_progressbardirection(enumDirection) // set
TileFrameSet.progressbardirection // get
```
...
**Syntax**
```javascript
TileFrameSet.set_progressbargap(nSize) // set
TileFrameSet.progressbargap // get
```
...
**Syntax**
```javascript
TileFrameSet.set_progressbarsize(nSize) // set
TileFrameSet.progressbarsize // get
```
...
**Syntax**
```javascript
TileFrameSet.set_progressbarsmooth(bSmooth) // set
TileFrameSet.progressbarsmooth // get
```
...
**Syntax**
```javascript
TileFrameSet.set_right(nRight) // set
TileFrameSet.right // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_separatecount(nCount) // set
TileFrameSet.separatecount // get
```

**Setting Syntax**
```javascript
한 행 또는 열에 표시하는 자식 Frame 의 갯수를 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_separatesize(strSize) // set
TileFrameSet.separatesize // get
```

**Setting Syntax**
```javascript
각 자식 Frame 별로 표시될 크기를 콤마(",")로 구분하여 설정합니다.
...
**Syntax**
```javascript
TileFrameSet.set_separatetype(enumType) // set
TileFrameSet.separatetype // get
```

**Setting Syntax**
```javascript
수직(위쪽에서 아랫쪽) 기준으로 separatecount 속성값만큼 Frame을 배치 한 후 나머지 Frame 을 다음 열에 배치합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_showcascadestatustext(bShow) // set
TileFrameSet.showcascadestatustext // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 statustext 속성값만 표시합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_showcascadetitletext(bShow) // set
TileFrameSet.showcascadetitletext // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 titletext 속성값만 표시합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_showstatusbar(bshowstatus) // set
TileFrameSet.showstatusbar // get
```

**Setting Syntax**
```javascript
TileFrameSet 에 StatusBar 를 표시하지 않습니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_showtitlebar(bshowtitlebar) // set
TileFrameSet.showtitlebar // get
```

**Setting Syntax**
```javascript
TileFrameSet 에 TitleBar 를 표시하지 않습니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_showtitleicon(bshowtitleicon) // set
TileFrameSet.showtitleicon // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 타이틀바에 아이콘을 표시하지 않습니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_statusbarheight(nHeight) // set
TileFrameSet.statusbarheight // get
```
...
**Syntax**
```javascript
TileFrameSet.set_statustext(strStatustext) // set
TileFrameSet.statustext // get
```
...
**Syntax**
```javascript
TileFrameSet.set_titlebarbuttongap(nGap) // set
TileFrameSet.titlebarbuttongap // get
```
...
**Syntax**
```javascript
TileFrameSet.set_titlebarbuttonsize(strSize) // set
TileFrameSet.titlebarbuttonsize // get
```
...
**Syntax**
```javascript
TileFrameSet.set_titlebarheight(nHeight) // set
TileFrameSet.titlebarheight // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 TitleBar 높이를 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_titletext(strTitletext) // set
TileFrameSet.titletext // get
```
...
**Syntax**
```javascript
TileFrameSet.set_top(nTop) // set
TileFrameSet.top // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_visible(bVisible) // set
TileFrameSet.visible // get
```

**Setting Syntax**
```javascript
TileFrameSet 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_width(nWidth) // set
TileFrameSet.width // get
```

**Setting Syntax**
```javascript
TileFrameSet 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
TileFrameSet.set_wordSpacing(strWordSpacing) // set
TileFrameSet.wordSpacing // get
```
