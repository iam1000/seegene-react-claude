...
| `tabkeycirculation` | 탭키 또는 Shift+탭키 입력으로 포커스 이동 시 Form 내에서 마지막 컴포넌트 또는 첫번째 컴포넌트에서 다른 Frame으로 포커스를 이동하 |
...
**Syntax**
```javascript
FrameSet.set_border(strborder) // set
FrameSet.border // get
```
...
**Syntax**
```javascript
FrameSet.set_background( strBackground ) // set 
FrameSet.background // get
```
...
**Syntax**
```javascript
FrameSet.set_borderRadius(strborderradius) // set
FrameSet.borderRadius // get
```
...
**Syntax**
```javascript
FrameSet.set_bottom(nBottom) // set
FrameSet.bottom // get
```

**Setting Syntax**
```javascript
FrameSet 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FrameSet.set_color(strcolor) // set
FrameSet.color // get
```
...
**Syntax**
```javascript
FrameSet.set_cssclass(strcssclass) // set
FrameSet.cssclass // get
```
...
**Syntax**
```javascript
FrameSet.set_cursor(strCursor) // set
FrameSet.cursor // get
```
...
**Syntax**
```javascript
FrameSet.set_enable(benable) // set
FrameSet.enable // get
```

**Setting Syntax**
```javascript
FrameSet 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
FrameSet.set_enableevent(bEvent) // set
FrameSet.enableevent // get
```

**Setting Syntax**
```javascript
FrameSet 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
FrameSet.set_height(nHeight) // set
FrameSet.height // get
```

**Setting Syntax**
```javascript
FrameSet 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FrameSet.set_hotkey(strHotkey) // set
FrameSet.hotkey // get
```
...
**Syntax**
```javascript
FrameSet.set_left(nLeft) // set
FrameSet.left // get
```

**Setting Syntax**
```javascript
FrameSet 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Setting Syntax**
```javascript
최소화 된 자식 Frame 이 FrameSet 내부의 아랫쪽 영역에 표시됩니다.
```
...
**Syntax**
```javascript
FrameSet.set_minimizeheight(nHeight) // set
FrameSet.minimizeheight // get
```
...
**Syntax**
```javascript
FrameSet.set_minimizewidth(nWidth) // set
FrameSet.minimizewidth // get
```
...
**Syntax**
```javascript
FrameSet.set_opacity(strOpacity) // set
FrameSet.opacity // get
```
...
**Syntax**
```javascript
FrameSet.set_progressbardirection(enumDirection) // set
FrameSet.progressbardirection // get
```
...
**Syntax**
```javascript
FrameSet.set_progressbargap(nSize) // set
FrameSet.progressbargap // get
```
...
**Syntax**
```javascript
FrameSet.set_progressbarsize(nSize) // set
FrameSet.progressbarsize // get
```
...
**Syntax**
```javascript
FrameSet.set_progressbarsmooth(bSmooth) // set
FrameSet.progressbarsmooth // get
```
...
**Syntax**
```javascript
FrameSet.set_restorechildpositiontype(enumRestoreType) // set
FrameSet.restorechildpositiontype // get
```

**Setting Syntax**
```javascript
하위 ChildFrame 중 하나가 최대화 될 때 최대화 되어 있던 ChildFrame 은 크기를 유지합니다.
...
**Syntax**
```javascript
FrameSet.set_right(nRight) // set
FrameSet.right // get
```

**Setting Syntax**
```javascript
FrameSet 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FrameSet.set_showcascadestatustext(bShow) // set
FrameSet.showcascadestatustext // get
```

**Setting Syntax**
```javascript
FrameSet 의 statustext 속성값만 표시합니다.
```
...
**Syntax**
```javascript
FrameSet.set_showcascadetitletext(bShow) // set
FrameSet.showcascadetitletext // get
```

**Setting Syntax**
```javascript
FrameSet 의 titletext 속성값만 표시합니다.
```
...
**Syntax**
```javascript
FrameSet.set_showstatusbar(bshowstatus) // set
FrameSet.showstatusbar // get
```

**Setting Syntax**
```javascript
FrameSet 에 StatusBar 를 표시하지 않습니다.
```
...
**Syntax**
```javascript
FrameSet.set_showtitlebar(bshowtitlebar) // set
FrameSet.showtitlebar // get
```

**Setting Syntax**
```javascript
FrameSet 에 TitleBar 를 표시하지 않습니다.
```
...
**Syntax**
```javascript
FrameSet.set_showtitleicon(bshowtitleicon) // set
FrameSet.showtitleicon // get
```

**Setting Syntax**
```javascript
FrameSet 의 타이틀바에 아이콘을 표시하지 않습니다.
```
...
**Syntax**
```javascript
FrameSet.set_statusbarheight(nHeight) // set
FrameSet.statusbarheight // get
```
...
**Syntax**
```javascript
FrameSet.set_statustext(strStatustext) // set
FrameSet.statustext // get
```
...
**Syntax**
```javascript
FrameSet.set_tabkeycirculation(enumTabkeyCirculation) // set 
FrameSet.tabkeycirculation // get
```

**Setting Syntax**
```javascript
arrange 메소드 실행 시 파라미터에 따라 동작이 달라집니다.
...
**Syntax**
```javascript
FrameSet.set_titlebarbuttongap(nGap) // set
FrameSet.titlebarbuttongap // get
```
...
**Syntax**
```javascript
FrameSet.set_titlebarbuttonsize(strSize) // set
FrameSet.titlebarbuttonsize // get
```
...
**Syntax**
```javascript
FrameSet.set_titlebarheight(nHeight) // set
FrameSet.titlebarheight // get
```

**Setting Syntax**
```javascript
FrameSet 의 TitleBar 높이를 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FrameSet.set_titletext(strTitletext) // set
FrameSet.titletext // get
```
...
**Syntax**
```javascript
FrameSet.set_top(nTop) // set
FrameSet.top // get
```

**Setting Syntax**
```javascript
FrameSet 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
FrameSet.set_visible(bVisible) // set
FrameSet.visible // get
```

**Setting Syntax**
```javascript
FrameSet 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
FrameSet.set_width(nWidth) // set
FrameSet.width // get
```

**Setting Syntax**
```javascript
FrameSet 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
```
