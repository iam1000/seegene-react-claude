...
| `accessibilityaction` | Menu에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정 |
| `accessibilitydesclevel` | Menu 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | Menu에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 descript |
| `accessibilityenable` | Menu 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | Menu에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보 |
...
**Syntax**
```javascript
Menu.set_padding(strpadding) // set
Menu.padding // get
```

**Setting Syntax**
```javascript
Menu 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
Menu.set_accessibilityaction(strAction) // set
Menu.accessibilityaction // get
```
...
**Syntax**
```javascript
Menu.set_accessibilitydesclevel(enumLevel) // set
Menu.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
Menu 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
Menu.set_accessibilitydescription(strDescription) // set
Menu.accessibilitydescription // get
```
...
**Syntax**
```javascript
Menu.set_accessibilityenable(bEnable) // set
Menu.accessibilityenable // get
```

**Setting Syntax**
```javascript
Menu 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
Menu.set_accessibilitylabel(strLabel) // set
Menu.accessibilitylabel // get
```
...
**Syntax**
```javascript
Menu.set_accessibilityrole(enumRole) // set
Menu.accessibilityrole // get
```
...
**Syntax**
```javascript
Menu.set_background( strBackground ) // set 
Menu.background // get
```
...
**Syntax**
```javascript
Menu.set_borderRadius(strborderradius) // set
Menu.borderRadius // get
```
...
**Syntax**
```javascript
Menu.set_bottom(nBottom) // set
Menu.bottom // get
```

**Setting Syntax**
```javascript
Menu 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 Menu 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Menu 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 Menu 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Menu 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Menu.set_boxShadow(strbshadow) // set
Menu.boxShadow // get
```
...
**Syntax**
```javascript
Menu.set_captioncolumn(strColumnID) // set
Menu.captioncolumn // get
```

**Setting Syntax**
```javascript
Menu 컴포넌트에 아이템으로 표시될 텍스트가 정의된 Column 의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_checkboxcolumn(strColumnID) // set
Menu.checkboxcolumn // get
```
...
**Syntax**
```javascript
Menu.set_cssclass(strcssclass) // set
Menu.cssclass // get
```
...
**Syntax**
```javascript
Menu.set_enable(benable) // set
Menu.enable // get
```

**Setting Syntax**
```javascript
Menu 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
Menu.set_enablecolumn(strColumnID) // set
Menu.enablecolumn // get
```

**Setting Syntax**
```javascript
메뉴 아이템의 활성화 여부가 정의된 Column의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_enableevent(bEvent) // set
Menu.enableevent // get
```

**Setting Syntax**
```javascript
Menu 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_fittocontents(enumFitTo) // set
Menu.fittocontents // get
```

**Setting Syntax**
```javascript
컨텐츠 내용에 맞게 Menu 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.
```
...
**Syntax**
```javascript
Menu.set_height(nHeight) // set
Menu.height // get
```

**Setting Syntax**
```javascript
Menu 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Menu 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Menu 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
Menu.set_hotkeycolumn(strColumnID) // set
Menu.hotkeycolumn // get
```
...
**Syntax**
```javascript
Menu.set_iconcolumn(strColumnID) // set
Menu.iconcolumn // get
```

**Setting Syntax**
```javascript
아이콘의 정보가 정의된 Column 의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_idcolumn(strColumnID) // set
Menu.idcolumn // get
```

**Setting Syntax**
```javascript
메뉴 아이템의 ID가 정의된 Column의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_initvalueid(strValueID) // set
Menu.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 Menu 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_innerdataset(strDatasetID) // set
Menu.innerdataset // get
```

**Setting Syntax**
```javascript
메뉴 아이템이 정의된 DataSet의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_layoutorder(nVal) // set
Menu.layoutorder // get
```
...
**Syntax**
```javascript
Menu.set_left(nLeft) // set
Menu.left // get
```

**Setting Syntax**
```javascript
Menu 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 Menu 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Menu 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 Menu 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Menu 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Menu.set_letterSpacing(strspace) // set
Menu.letterSpacing // get
```
...
**Syntax**
```javascript
Menu.set_levelcolumn(strColumnID) // set
Menu.levelcolumn // get
```

**Setting Syntax**
```javascript
각 메뉴 아이템의 상/하위 관계가 정의된 Column의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_maxheight(nMaxHeight) // set
Menu.maxheight // get
```

**Setting Syntax**
```javascript
Menu 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_maxwidth(nMaxWidth) // set
Menu.maxwidth // get
```

**Setting Syntax**
```javascript
Menu 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_minheight(nMinHeight) // set
Menu.minheight // get
```

**Setting Syntax**
```javascript
Menu 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_minwidth(nMinWidth) // set
Menu.minwidth // get
```

**Setting Syntax**
```javascript
Menu 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_navigationbuttonsize(nSize) // set
Menu.navigationbuttonsize // get
```

**Setting Syntax**
```javascript
메뉴 리스트의 좌/우에 표시되는 스크롤버튼(prevbutton/nextbutton)의 너비를 pixel 단위의 숫자로 설정합니다.
...
**See Also**: popupnavigationbuttonsize
...
**Syntax**
```javascript
Menu.set_opacity(strOpacity) // set
Menu.opacity // get
```
...
**Syntax**
```javascript
Menu.set_popupitemheight(nHeight) // set
Menu.popupitemheight // get
```

**Setting Syntax**
```javascript
각 메뉴 항목의 높이를 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Menu.set_popupnavigationbuttonsize(nSize) // set
Menu.popupnavigationbuttonsize // get
```

**Setting Syntax**
```javascript
서브메뉴 리스트의 상/하에 표시되는 스크롤버튼(prevbutton/nextbutton)의 높이를 pixel 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
Menu.set_popuptype(enumType) // set
Menu.popuptype // get
```

**Setting Syntax**
```javascript
Application이 실행중인 화면의 중앙에 하위 메뉴가 표시됩니다
```
...
**Syntax**
```javascript
Menu.set_positionstep(nStep) // set
Menu.positionstep // get
```

**Setting Syntax**
```javascript
Menu 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
Menu.set_right(nRight) // set
Menu.right // get
```

**Setting Syntax**
```javascript
Menu 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 Menu 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Menu 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 Menu 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Menu 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
Menu 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
Menu.set_tablecellarea(strArea) // set
Menu.tablecellarea // get
```
...
**Syntax**
```javascript
Menu.set_taborder(nTabOrder) // set
Menu.taborder // get
```
...
**Syntax**
```javascript
Menu.set_tabstop(bTabStop) // set
Menu.tabstop // get
```

**Setting Syntax**
```javascript
Menu 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
Menu.set_tooltiptext(strToolTipText) // set
Menu.tooltiptext // get
```
...
**Syntax**
```javascript
Menu.set_tooltiptype(enumTooltipType) // set
Menu.tooltiptype // get
```

**Setting Syntax**
```javascript
Menu 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
Menu.set_top(nTop) // set
Menu.top // get
```

**Setting Syntax**
```javascript
Menu 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 Menu 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Menu 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 Menu 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Menu 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Menu.set_userdatacolumn(strColumnID) // set
Menu.userdatacolumn // get
```
...
**Syntax**
```javascript
Menu.set_visible(bVisible) // set
Menu.visible // get
```

**Setting Syntax**
```javascript
Menu 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
Menu.set_width(nWidth) // set
Menu.width // get
```

**Setting Syntax**
```javascript
Menu 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Menu 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Menu 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
Menu.set_wordSpacing(strWordSpacing) // set
Menu.wordSpacing // get
```
