...
| `accessibilityaction` | Radio에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action  |
| `accessibilitydesclevel` | Radio 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | Radio에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 descrip |
| `accessibilityenable` | Radio 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | Radio에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정 |
...
**Syntax**
```javascript
Radio.set_border(strborder) // set
Radio.border // get
```
...
**Syntax**
```javascript
Radio.set_padding(strpadding) // set
Radio.padding // get
```

**Setting Syntax**
```javascript
Radio 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
Radio.set_acceptvaluetype( enumAccept ) // set 
Radio.acceptvaluetype // get
```
...
**Syntax**
```javascript
Radio.set_accessibilityaction(strAction) // set
Radio.accessibilityaction // get
```
...
**Syntax**
```javascript
Radio.set_accessibilitydesclevel(enumLevel) // set
Radio.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
Radio 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
Radio.set_accessibilitydescription(strDescription) // set
Radio.accessibilitydescription // get
```
...
**Syntax**
```javascript
Radio.set_accessibilityenable(bEnable) // set
Radio.accessibilityenable // get
```

**Setting Syntax**
```javascript
Radio 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
Radio.set_accessibilitylabel(strLabel) // set
Radio.accessibilitylabel // get
```
...
**Syntax**
```javascript
Radio.set_accessibilityrole(enumRole) // set
Radio.accessibilityrole // get
```
...
**Syntax**
```javascript
Radio.set_background( strBackground ) // set 
Radio.background // get
```
...
**Syntax**
```javascript
Radio.set_borderRadius(strborderradius) // set
Radio.borderRadius // get
```
...
**Syntax**
```javascript
Radio.set_bottom(nBottom) // set
Radio.bottom // get
```

**Setting Syntax**
```javascript
Radio 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 Radio 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Radio 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 Radio 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Radio 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Radio.set_boxShadow(strbshadow) // set
Radio.boxShadow // get
```
...
**Syntax**
```javascript
Radio.set_codecolumn(strColumnID) // set
Radio.codecolumn // get
```

**Setting Syntax**
```javascript
innerdataset 속성에 설정된 DataSet 의 Column 중 코드값으로 사용할 Column의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_columncount(nColcount) // set
Radio.columncount // get
```

**Setting Syntax**
```javascript
한 행에 표시되는 아이템의 갯수를 -1 이상의 숫자로 설정합니다.
...
**Syntax**
```javascript
Radio.set_cssclass(strcssclass) // set
Radio.cssclass // get
```
...
**Syntax**
```javascript
Radio.set_cursor(strCursor) // set
Radio.cursor // get
```
...
**Syntax**
```javascript
Radio.set_datacolumn(strColumnID) // set
Radio.datacolumn // get
```

**Setting Syntax**
```javascript
innerdataset 속성에 설정된 DataSet 의 Column 중 데이터값으로 사용할 Column의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_direction(enumDirection) // set
Radio.direction // get
```
...
**Syntax**
```javascript
Radio.set_enable(benable) // set
Radio.enable // get
```

**Setting Syntax**
```javascript
Radio 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
Radio.set_enableevent(bEvent) // set
Radio.enableevent // get
```

**Setting Syntax**
```javascript
Radio 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_fittocontents(enumFitTo) // set
Radio.fittocontents // get
```

**Setting Syntax**
```javascript
컨텐츠 내용에 맞게 Radio 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.
```
...
**Syntax**
```javascript
Radio.set_flexshrink(fVal) // set
Radio.flexshrink // get
```
...
**Syntax**
```javascript
Radio.set_height(nHeight) // set
Radio.height // get
```

**Setting Syntax**
```javascript
Radio 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Radio 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Radio 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
Radio.set_hotkey(strHotkey) // set
Radio.hotkey // get
```
...
**Syntax**
```javascript
Radio.set_initvalueid(strValueID) // set
Radio.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 Radio 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_innerdataset(strDatasetID) // set
Radio.innerdataset // get
```

**Setting Syntax**
```javascript
아이템 리스트를 구성할 DataSet 의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_itemaccessibilityenable(bItemEnable) // set
Radio.itemaccessibilityenable // get
```

**Setting Syntax**
```javascript
Radio 에 선택상자가 이동되었을 때 하위 아이템의 접근성 관련값을 출력하지 않습니다.
...
**Syntax**
```javascript
Radio.set_layoutorder(nVal) // set
Radio.layoutorder // get
```
...
**Syntax**
```javascript
Radio.set_left(nLeft) // set
Radio.left // get
```

**Setting Syntax**
```javascript
Radio 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 Radio 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Radio 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 Radio 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Radio 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Radio.set_letterSpacing(strspace) // set
Radio.letterSpacing // get
```
...
**Syntax**
```javascript
Radio.set_maxheight(nMaxHeight) // set
Radio.maxheight // get
```

**Setting Syntax**
```javascript
Radio 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_maxwidth(nMaxWidth) // set
Radio.maxwidth // get
```

**Setting Syntax**
```javascript
Radio 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_minheight(nMinHeight) // set
Radio.minheight // get
```

**Setting Syntax**
```javascript
Radio 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_minwidth(nMinWidth) // set
Radio.minwidth // get
```

**Setting Syntax**
```javascript
Radio 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_opacity(strOpacity) // set
Radio.opacity // get
```
...
**Syntax**
```javascript
Radio.set_positionstep(nStep) // set
Radio.positionstep // get
```

**Setting Syntax**
```javascript
Radio 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
Radio.set_readonly(bReadOnly) // set
Radio.readonly // get
```

**Setting Syntax**
```javascript
Radio 에 선택된 아이템을 변경할 수 있습니다.
```
...
**Syntax**
```javascript
Radio.set_right(nRight) // set
Radio.right // get
```

**Setting Syntax**
```javascript
Radio 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 Radio 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Radio 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 Radio 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Radio 의 우측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Radio.set_rowcount(nRowCount) // set
Radio.rowcount // get
```

**Setting Syntax**
```javascript
한 열에 표시되는 아이템의 갯수를 -1 이상의 숫자로 설정합니다.
...
**Setting Syntax**
```javascript
Radio 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
Radio.set_tablecellarea(strArea) // set
Radio.tablecellarea // get
```
...
**Syntax**
```javascript
Radio.set_taborder(nTabOrder) // set
Radio.taborder // get
```
...
**Syntax**
```javascript
Radio.set_tabstop(bTabStop) // set
Radio.tabstop // get
```

**Setting Syntax**
```javascript
Radio 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
Radio.set_tooltiptext(strToolTipText) // set
Radio.tooltiptext // get
```
...
**Syntax**
```javascript
Radio.set_tooltiptype(enumTooltipType) // set
Radio.tooltiptype // get
```

**Setting Syntax**
```javascript
Radio 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
Radio.set_top(nTop) // set
Radio.top // get
```

**Setting Syntax**
```javascript
Radio 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 Radio 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 Radio 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 Radio 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 Radio 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
Radio.set_value(strValue) // set
Radio.value // get
```

**Setting Syntax**
```javascript
Radio 의 아이템 중에서 선택할 아이템의 코드값을 문자열로 설정합니다.
```
...
**Syntax**
```javascript
Radio.set_visible(bVisible) // set
Radio.visible // get
```

**Setting Syntax**
```javascript
Radio 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
Radio.set_width(nWidth) // set
Radio.width // get
```

**Setting Syntax**
```javascript
Radio 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 Radio 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 Radio 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
Radio.set_wordSpacing(strWordSpacing) // set
Radio.wordSpacing // get
```
