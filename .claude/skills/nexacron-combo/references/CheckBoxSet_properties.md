...
| `accessibilityaction` | CheckBoxSet에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 a |
| `accessibilitydesclevel` | CheckBoxSet 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | CheckBoxSet에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 d |
| `accessibilityenable` | CheckBoxSet 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | CheckBoxSet에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 l |
| `accessibilityrole` | CheckBoxSet에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
...
| `itemaccessibilityenable` | CheckBoxSet 컴포넌트에 선택상자가 이동되었을 때 하위 아이템의 접근성 출력여부를 설정하는 속성입니다. |
...
**Syntax**
```javascript
CheckBoxSet.set_border(strborder) // set
CheckBoxSet.border // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_edge(stredge) // set
CheckBoxSet.edge // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_padding(strpadding) // set
CheckBoxSet.padding // get
```

**Setting Syntax**
```javascript
CheckBoxSet 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
CheckBoxSet.set_acceptvaluetype( enumAccept ) // set 
CheckBoxSet.acceptvaluetype // get
```

**Setting Syntax**
```javascript
index, value, text 속성을 변경하지 않고 기존값을 유지합니다.
```
...
CheckBoxSet에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**
```javascript
CheckBoxSet.set_accessibilityaction(strAction) // set
CheckBoxSet.accessibilityaction // get
```
...
CheckBoxSet 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**
```javascript
CheckBoxSet.set_accessibilitydesclevel(enumLevel) // set
CheckBoxSet.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
CheckBoxSet 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 CheckBoxSet 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.

---

## accessibilitydescription

CheckBoxSet에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**
```javascript
CheckBoxSet.set_accessibilitydescription(strDescription) // set
CheckBoxSet.accessibilitydescription // get
```
...
CheckBoxSet 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**
```javascript
CheckBoxSet.set_accessibilityenable(bEnable) // set
CheckBoxSet.accessibilityenable // get
```

**Setting Syntax**
```javascript
CheckBoxSet 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 CheckBoxSet 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 CheckBoxSet 에 이동되지 않습니다.
```
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Status : CheckBoxSet 의 현재 상태가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 CheckBoxSet 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 CheckBoxSet 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
CheckBoxSet에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**
```javascript
CheckBoxSet.set_accessibilitylabel(strLabel) // set
CheckBoxSet.accessibilitylabel // get
```
...
CheckBoxSet에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**
```javascript
CheckBoxSet.set_accessibilityrole(enumRole) // set
CheckBoxSet.accessibilityrole // get
```
...
- accessibilityenable 속성값을 설정하지 않으면 CheckBoxSet의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 CheckBoxSet에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
**Syntax**
```javascript
CheckBoxSet.set_background( strBackground ) // set 
CheckBoxSet.background // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_borderRadius(strborderradius) // set
CheckBoxSet.borderRadius // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_bottom(nBottom) // set
CheckBoxSet.bottom // get
```

**Setting Syntax**
```javascript
CheckBoxSet 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 CheckBoxSet 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 CheckBoxSet 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 CheckBoxSet 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 CheckBoxSet 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_boxShadow(strbshadow) // set
CheckBoxSet.boxShadow // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_codecolumn(strColumnID) // set 
CheckBoxSet.codecolumn // get
```

**Setting Syntax**
```javascript
innerdataset 속성에 설정된 Dataset 오브젝트의 Column 중 코드값으로 사용할 Column의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_color(strcolor) // set
CheckBoxSet.color // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_columncount(nColcount) // set 
CheckBoxSet.columncount // get
```

**Setting Syntax**
```javascript
한 행에 표시되는 아이템의 개수를 -1 이상의 숫자로 설정합니다.
...
**Syntax**
```javascript
CheckBoxSet.set_cssclass(strcssclass) // set
CheckBoxSet.cssclass // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_cursor(strCursor) // set
CheckBoxSet.cursor // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_datacolumn(strColumnID) // set 
CheckBoxSet.datacolumn // get
```

**Setting Syntax**
```javascript
innerdataset 속성에 설정된 Dataset 오브젝트의 Column 중 데이터값으로 사용할 Column의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_direction(enumDirection) // set 
CheckBoxSet.direction // get
```

**Setting Syntax**
```javascript
아이템 순서대로 위에서 아래 방향으로 표시하고 다음 열을 표시합니다.
...
**Syntax**
```javascript
CheckBoxSet.set_enable(benable) // set
CheckBoxSet.enable // get
```

**Setting Syntax**
```javascript
CheckBoxSet 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
CheckBoxSet.set_enableevent(bEvent) // set
CheckBoxSet.enableevent // get
```

**Setting Syntax**
```javascript
CheckBoxSet 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_fittocontents(enumFitTo) // set
CheckBoxSet.fittocontents // get
```

**Setting Syntax**
```javascript
컨텐츠 내용에 맞게 CheckBoxSet 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.
```
...
- IE11 이하 버전 브라우저에서 Button, FileDownload, Static 컴포넌트 사용 시 아래와 같은 제약이 발생할 수 있습니다.
fittocontents 속성값을 "width" 또는 "both"로 설정하고 wordWrap 속성값을 "char" 또는 "english"로 설정했을 때 의도하지 않은 줄바꿈이 발생할 수 있습니다. IE11 이하 버전 브라우저에서는 font 크기 처리 시 소수점 이하의 값을 반환하지 않으며 이로 인해 너비 계산이 달라지는 현상입니다.
IE11 이하 버전 브라우저에서는 두 가지 속성을 조합해서 사용하지 않거나 글꼴 크기를 조정하는 방법으로 우회할 수 있습니다.
...
**Syntax**
```javascript
CheckBoxSet.set_flexgrow(fVal) // set
CheckBoxSet.flexgrow // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_flexshrink(fVal) // set
CheckBoxSet.flexshrink // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_font(strfont) // set
CheckBoxSet.font // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_height(nHeight) // set
CheckBoxSet.height // get
```

**Setting Syntax**
```javascript
CheckBoxSet 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 CheckBoxSet 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 CheckBoxSet 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_hotkey(strHotkey) // set
CheckBoxSet.hotkey // get
```
...
**Setting Syntax**
```javascript
CheckBoxSet를 구별할 수 있는 유일값을 갖습니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_index(strIndex) // set 
CheckBoxSet.index // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_initvalueid(strValueID) // set
CheckBoxSet.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 CheckBoxSet 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_innerdataset(strDatasetID) // set 
CheckBoxSet.innerdataset // get
```

**Setting Syntax**
```javascript
아이템 리스트를 구성할 Dataset 오브젝트의 ID를 문자열로 설정합니다.
```
...
CheckBoxSet 컴포넌트에 선택상자가 이동되었을 때 하위 아이템의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**
```javascript
CheckBoxSet.set_itemaccessibilityenable(bItemEnable) // set 
CheckBoxSet.itemaccessibilityenable // get
```

**Setting Syntax**
```javascript
CheckBoxSet 컴포넌트에 선택상자가 이동되었을 때 하위 아이템의 접근성 관련값을 출력하지 않습니다.

방향키 또는 제스처로 CheckBoxSet 컴포넌트의 아이템에 선택상자가 이동되지 않습니다.
```

**Remark**
- itemaccessibilityenable 속성값을 설정하지 않으면 true로 적용됩니다.

- enableaccessibility 속성값이 true 인 경우만 적용되는 속성입니다.

- CheckBoxSet 컴포넌트의 아이템에 선택상자 이동 시 Status + Value + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
  각 정보의 조합순서는 스크린 리더의 종류에 따라 달라질 수 있습니다.
  > Status : 현재 아이템의 상태가 반영됩니다. (선택/해제 등)
  > Value : 현재 아이템에 표시된 텍스트가 반영됩니다.
  > Role : 아이템의 고유 Role 인 "checkbox" 값이 반영됩니다.

- itemaccessibilityenable 속성값이 false 일 때 Desktop 환경에서 방향키 외의 방법으로 선택상자를 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.


◆ Mobile 제약

- 모바일 환경에서는 Div 컴포넌트 같은 컨테이너 컴포넌트 자체에 선택상자가 이동하지 않습니다.
...
**Syntax**
```javascript
CheckBoxSet.set_layoutorder(nVal) // set
CheckBoxSet.layoutorder // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_left(nLeft) // set
CheckBoxSet.left // get
```

**Setting Syntax**
```javascript
CheckBoxSet 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 CheckBoxSet 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 CheckBoxSet 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 CheckBoxSet 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 CheckBoxSet 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_letterSpacing(strspace) // set
CheckBoxSet.letterSpacing // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_maxheight(nMaxHeight) // set
CheckBoxSet.maxheight // get
```

**Setting Syntax**
```javascript
CheckBoxSet 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_maxwidth(nMaxWidth) // set
CheckBoxSet.maxwidth // get
```

**Setting Syntax**
```javascript
CheckBoxSet 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_minheight(nMinHeight) // set
CheckBoxSet.minheight // get
```

**Setting Syntax**
```javascript
CheckBoxSet 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_minwidth(nMinWidth) // set
CheckBoxSet.minwidth // get
```

**Setting Syntax**
```javascript
CheckBoxSet 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_name(strName) // set
CheckBoxSet.name // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_opacity(strOpacity) // set
CheckBoxSet.opacity // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_positionstep(nStep) // set
CheckBoxSet.positionstep // get
```

**Setting Syntax**
```javascript
CheckBoxSet 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
CheckBoxSet.set_readonly(bReadOnly) // set 
CheckBoxSet.readonly // get
```

**Setting Syntax**
```javascript
CheckBoxSet 컴포넌트에 선택된 아이템을 변경할 수 있습니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_readonlycolumn(strColumnID) // set 
CheckBoxSet.readonlycolumn // get
```

**Setting Syntax**
```javascript
innerdataset 속성에 설정된 Dataset 오브젝트의 Column 중 아이템 readonly 여부를 설정할 Column의 ID를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_right(nRight) // set
CheckBoxSet.right // get
```

**Setting Syntax**
```javascript
CheckBoxSet 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 CheckBoxSet 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 CheckBoxSet 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 CheckBoxSet 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 CheckBoxSet 의 우측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_rowcount(nRowCount) // set 
CheckBoxSet.rowcount // get
```

**Setting Syntax**
```javascript
한 열에 표시되는 아이템의 개수를 -1 이상의 숫자로 설정합니다.
...
**Setting Syntax**
```javascript
CheckBoxSet 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
- rtl 속성값이 false 로 적용되면 아랍어 같은 오른쪽 기준의 언어는 정상적으로 표시되지 않을 수 있습니다.
...
**Syntax**
```javascript
CheckBoxSet.set_tablecellarea(strArea) // set
CheckBoxSet.tablecellarea // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_taborder(nTabOrder) // set
CheckBoxSet.taborder // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_tabstop(bTabStop) // set
CheckBoxSet.tabstop // get
```

**Setting Syntax**
```javascript
CheckBoxSet 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
CheckBoxset.set_textseparator(strTextSeparator) // set 
CheckBoxset.textseparator // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_tooltiptext(strToolTipText) // set
CheckBoxSet.tooltiptext // get
```
...
**Syntax**
```javascript
CheckBoxSet.set_tooltiptype(enumTooltipType) // set
CheckBoxSet.tooltiptype // get
```

**Setting Syntax**
```javascript
CheckBoxSet 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
CheckBoxSet.set_top(nTop) // set
CheckBoxSet.top // get
```

**Setting Syntax**
```javascript
CheckBoxSet 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 CheckBoxSet 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 CheckBoxSet 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 CheckBoxSet 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 CheckBoxSet 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_value(strValue) // set 
CheckBoxSet.value // get
```

**Setting Syntax**
```javascript
아이템 리스트 중에서 선택할 아이템의 코드값을 1개 이상 구분자를 사용해 설정합니다.
...
**Syntax**
```javascript
CheckBoxSet.set_visible(bVisible) // set
CheckBoxSet.visible // get
```

**Setting Syntax**
```javascript
CheckBoxSet 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_width(nWidth) // set
CheckBoxSet.width // get
```

**Setting Syntax**
```javascript
CheckBoxSet 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 CheckBoxSet 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 CheckBoxSet 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBoxSet.set_wordSpacing(strWordSpacing) // set
CheckBoxSet.wordSpacing // get
```
