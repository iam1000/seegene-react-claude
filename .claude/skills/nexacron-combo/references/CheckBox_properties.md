...
| `accessibilityaction` | CheckBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 acti |
| `accessibilitydesclevel` | CheckBox 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | CheckBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 desc |
| `accessibilityenable` | CheckBox 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | CheckBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 labe |
...
**Syntax**
```javascript
CheckBox.set_border(strborder) // set
CheckBox.border // get
```
...
**Syntax**
```javascript
CheckBox.set_iconPosition(striconpos) // set
CheckBox.iconPosition // get
```
...
**Syntax**
```javascript
CheckBox.set_padding(strpadding) // set
CheckBox.padding // get
```

**Setting Syntax**
```javascript
CheckBox 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
CheckBox.set_textAlign(strtextalign) // set
CheckBox.textAlign // get
```
...
**Syntax**
```javascript
CheckBox.set_textDecoration(strTxtDeco) // set
CheckBox.textDecoration // get
```
...
**Syntax**
```javascript
CheckBox.set_textPadding(strtextpadding) // set
CheckBox.textPadding // get
```
...
**Syntax**
```javascript
CheckBox.set_verticalAlign(strvertalign) // set
CheckBox.verticalAlign // get
```
...
**Syntax**
```javascript
CheckBox.set_accessibilityaction(strAction) // set
CheckBox.accessibilityaction // get
```
...
**Syntax**
```javascript
CheckBox.set_accessibilitydesclevel(enumLevel) // set
CheckBox.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
CheckBox 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
CheckBox.set_accessibilitydescription(strDescription) // set
CheckBox.accessibilitydescription // get
```
...
**Syntax**
```javascript
CheckBox.set_accessibilityenable(bEnable) // set
CheckBox.accessibilityenable // get
```

**Setting Syntax**
```javascript
CheckBox 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
CheckBox.set_accessibilitylabel(strLabel) // set
CheckBox.accessibilitylabel // get
```
...
**Syntax**
```javascript
CheckBox.set_accessibilityrole(enumRole) // set
CheckBox.accessibilityrole // get
```
...
**Syntax**
```javascript
CheckBox.set_background( strBackground ) // set 
CheckBox.background // get
```
...
**Syntax**
```javascript
CheckBox.set_borderRadius(strborderradius) // set
CheckBox.borderRadius // get
```
...
**Syntax**
```javascript
CheckBox.set_bottom(nBottom) // set
CheckBox.bottom // get
```

**Setting Syntax**
```javascript
CheckBox 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 CheckBox 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 CheckBox 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 CheckBox 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 CheckBox 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBox.set_boxShadow(strbshadow) // set
CheckBox.boxShadow // get
```
...
**Syntax**
```javascript
CheckBox.set_color(strcolor) // set
CheckBox.color // get
```
...
**Syntax**
```javascript
CheckBox.set_cssclass(strcssclass) // set
CheckBox.cssclass // get
```
...
**Syntax**
```javascript
CheckBox.set_cursor(strCursor) // set
CheckBox.cursor // get
```
...
**Syntax**
```javascript
CheckBox.set_enable(benable) // set
CheckBox.enable // get
```

**Setting Syntax**
```javascript
CheckBox 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
CheckBox.set_enableevent(bEvent) // set
CheckBox.enableevent // get
```

**Setting Syntax**
```javascript
CheckBox 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Remark**
- 동적으로 CheckBox 에 적용된 텍스트는 getDisplayText() 메소드를 사용하여 확인할 수 있습니다.
...
**Syntax**
```javascript
CheckBox.set_falsevalue(strValue) // set
CheckBox.falsevalue // get
```

**Setting Syntax**
```javascript
CheckBox의 체크를 해제하기 위해 value속성값과 비교 할 문자열로 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_fittocontents(enumFitTo) // set
CheckBox.fittocontents // get
```

**Setting Syntax**
```javascript
컨텐츠 내용에 맞게 CheckBox 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_flexgrow(fVal) // set
CheckBox.flexgrow // get
```
...
**Syntax**
```javascript
CheckBox.set_flexshrink(fVal) // set
CheckBox.flexshrink // get
```
...
**Syntax**
```javascript
CheckBox.set_height(nHeight) // set
CheckBox.height // get
```

**Setting Syntax**
```javascript
CheckBox 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 CheckBox 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 CheckBox 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBox.set_hotkey(strHotkey) // set
CheckBox.hotkey // get
```
...
**Syntax**
```javascript
CheckBox.set_initvalueid(strValueID) // set
CheckBox.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 CheckBox 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_layoutorder(nVal) // set
CheckBox.layoutorder // get
```
...
**Syntax**
```javascript
CheckBox.set_left(nLeft) // set
CheckBox.left // get
```

**Setting Syntax**
```javascript
CheckBox 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 CheckBox 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 CheckBox 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 CheckBox 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 CheckBox 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBox.set_letterSpacing(strspace) // set
CheckBox.letterSpacing // get
```
...
**Syntax**
```javascript
CheckBox.set_maxheight(nMaxHeight) // set
CheckBox.maxheight // get
```

**Setting Syntax**
```javascript
CheckBox 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_maxwidth(nMaxWidth) // set
CheckBox.maxwidth // get
```

**Setting Syntax**
```javascript
CheckBox 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_minheight(nMinHeight) // set
CheckBox.minheight // get
```

**Setting Syntax**
```javascript
CheckBox 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_minwidth(nMinWidth) // set
CheckBox.minwidth // get
```

**Setting Syntax**
```javascript
CheckBox 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_opacity(strOpacity) // set
CheckBox.opacity // get
```
...
**Syntax**
```javascript
CheckBox.set_positionstep(nStep) // set
CheckBox.positionstep // get
```

**Setting Syntax**
```javascript
CheckBox 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
CheckBox.set_readonly(bReadOnly) // set
CheckBox.readonly // get
```

**Setting Syntax**
```javascript
CheckBox 의 편집을 가능하게 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_right(nRight) // set
CheckBox.right // get
```

**Setting Syntax**
```javascript
CheckBox 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 CheckBox 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 CheckBox 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 CheckBox 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 CheckBox 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
CheckBox 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
CheckBox.set_tablecellarea(strArea) // set
CheckBox.tablecellarea // get
```
...
**Syntax**
```javascript
CheckBox.set_taborder(nTabOrder) // set
CheckBox.taborder // get
```
...
**Syntax**
```javascript
CheckBox.set_tabstop(bTabStop) // set
CheckBox.tabstop // get
```

**Setting Syntax**
```javascript
CheckBox 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
CheckBox.set_text(strText) // set
CheckBox.text // get
```

**Setting Syntax**
```javascript
CheckBox 에 표시될 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_textwidth(nWidth) // set
CheckBox.textwidth // get
```

**Setting Syntax**
```javascript
텍스트가 표시되는 내부영역의 너비를 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_tooltiptext(strToolTipText) // set
CheckBox.tooltiptext // get
```
...
**Syntax**
```javascript
CheckBox.set_tooltiptype(enumTooltipType) // set
CheckBox.tooltiptype // get
```

**Setting Syntax**
```javascript
CheckBox 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
CheckBox.set_top(nTop) // set
CheckBox.top // get
```

**Setting Syntax**
```javascript
CheckBox 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 CheckBox 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 CheckBox 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 CheckBox 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 CheckBox 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBox.set_truevalue(strValue) // set
CheckBox.truevalue // get
```

**Setting Syntax**
```javascript
CheckBox의 체크를 설정하기 위해 value속성값과 비교 할 문자열로 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_value(strValue) // set
CheckBox.value // get
```

**Setting Syntax**
```javascript
truevalue 속성값 또는 falsevalue 속성값을 설정합니다.
```
...
**Syntax**
```javascript
CheckBox.set_visible(bVisible) // set
CheckBox.visible // get
```

**Setting Syntax**
```javascript
CheckBox 을(를) 화면에 표시하지 않습니다.
```
...
**Syntax**
```javascript
CheckBox.set_width(nWidth) // set
CheckBox.width // get
```

**Setting Syntax**
```javascript
CheckBox 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 CheckBox 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 CheckBox 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
CheckBox.set_wordSpacing(strWordSpacing) // set
CheckBox.wordSpacing // get
```
