...
| `-nexa-rtl-edge-image` | ListBoxItemControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입 |
...
**Setting Syntax**
```javascript
ListBoxItemControl 영역의 안쪽 여백을 pixel 단위로 설정합니다.
