# MultiComboTagBoxControl Properties
...
| `-nexa-rtl-edge-image` | MultiComboTagBoxControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하 |
...
**Setting Syntax**
```javascript
TagBoxControl 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Setting Syntax**
```javascript
MultiComboTagBoxControl 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
**Syntax**
```javascript
TagBoxControl.set_textAlign(strtextalign) // set
TagBoxControl.textAlign // get
```
...
**Syntax**
```javascript
MultiComboTagBoxControl.set_textAlign(strtextalign) // set
MultiComboTagBoxControl.textAlign // get
```
...
**Syntax**
```javascript
TagBoxControl.set_wordWrap(strwordwrap) // set
TagBoxControl.wordWrap // get
```
...
**Syntax**
```javascript
MultiComboTagBoxControl.set_wordWrap(strwordwrap) // set
MultiComboTagBoxControl.wordWrap // get
```
...
**Syntax**
```javascript
TagBoxControl.set_boxShadow(strbshadow) // set
TagBoxControl.boxShadow // get
```
...
**Syntax**
```javascript
MultiComboTagBoxControl.set_boxShadow(strbshadow) // set
MultiComboTagBoxControl.boxShadow // get
```
...
**Syntax**
```javascript
MultiComboTagBoxControl.cursor // get
```
