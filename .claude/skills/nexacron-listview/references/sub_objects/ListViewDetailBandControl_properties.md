# ListViewDetailBandControl Properties
...
| `-nexa-rtl-edge-image` | ListViewDetailBandControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설 |
| `accessibilityaction` | ListViewDetailBandControl에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 |
| `accessibilitydesclevel` | ListViewDetailBandControl 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | ListViewDetailBandControl에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 |
| `accessibilityenable` | ListViewDetailBandControl 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | ListViewDetailBandControl에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 |
...
**Syntax**
```javascript
ListViewDetailBandControl.set_border(strborder) // set
ListViewDetailBandControl.border // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_edge(stredge) // set
ListViewDetailBandControl.edge // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_accessibilityaction(strAction) // set
ListViewDetailBandControl.accessibilityaction // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_accessibilitydesclevel(enumLevel) // set
ListViewDetailBandControl.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
ListViewDetailBandControl 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_accessibilitydescription(strDescription) // set
ListViewDetailBandControl.accessibilitydescription // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_accessibilityenable(bEnable) // set
ListViewDetailBandControl.accessibilityenable // get
```

**Setting Syntax**
```javascript
ListViewDetailBandControl 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
ListViewDetailBandControl.set_accessibilitylabel(strLabel) // set
ListViewDetailBandControl.accessibilitylabel // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_accessibilityrole(enumRole) // set
ListViewDetailBandControl.accessibilityrole // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_background( strBackground ) // set 
ListViewDetailBandControl.background // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_borderRadius(strborderradius) // set
ListViewDetailBandControl.borderRadius // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_color(strcolor) // set
ListViewDetailBandControl.color // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_cssclass(strcssclass) // set
ListViewDetailBandControl.cssclass // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_cursor(strCursor) // set
ListViewDetailBandControl.cursor // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_font(strfont) // set
ListViewDetailBandControl.font // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_height(nHeight) // set
ListViewDetailBandControl.height // get
```

**Setting Syntax**
```javascript
ListViewDetailBandControl 의 높이를 픽셀 또는 비율("%") 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
ListViewDetailBandControl.set_letterSpacing(strspace) // set
ListViewDetailBandControl.letterSpacing // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_opacity(strOpacity) // set
ListViewDetailBandControl.opacity // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_tooltiptext(strToolTipText) // set
ListViewDetailBandControl.tooltiptext // get
```
...
**Syntax**
```javascript
ListViewDetailBandControl.set_tooltiptype(enumTooltipType) // set
ListViewDetailBandControl.tooltiptype // get
```

**Setting Syntax**
```javascript
ListViewDetailBandControl 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
ListViewDetailBandControl.set_width(nWidth) // set
ListViewDetailBandControl.width // get
```

**Setting Syntax**
```javascript
ListViewDetailBandControl 의 너비를 픽셀 또는 비율("%") 단위의 숫자로 설정합니다.
...
**Syntax**
```javascript
ListViewDetailBandControl.set_wordSpacing(strWordSpacing) // set
ListViewDetailBandControl.wordSpacing // get
```
