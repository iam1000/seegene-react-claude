...
| `accessibilityaction` | ListView에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 acti |
| `accessibilitydesclevel` | ListView 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| `accessibilitydescription` | ListView에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 desc |
| `accessibilityenable` | ListView 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| `accessibilitylabel` | ListView에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 labe |
...
| `autoupdatetype` | Cell이 Combo, MultiCombo, Calendar 중 하나의 형식일 때 팝업창으로 선택된 값이 Dataset 오브젝트에 적용되는 시점 |
...
**Syntax**
```javascript
ListView.set_border(strborder) // set
ListView.border // get
```
...
**Syntax**
```javascript
ListView.set_accessibilityaction(strAction) // set
ListView.accessibilityaction // get
```
...
**Syntax**
```javascript
ListView.set_accessibilitydesclevel(enumLevel) // set
ListView.accessibilitydesclevel // get
```

**Setting Syntax**
```javascript
ListView 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
```
...
**Syntax**
```javascript
ListView.set_accessibilitydescription(strDescription) // set
ListView.accessibilitydescription // get
```
...
**Syntax**
```javascript
ListView.set_accessibilityenable(bEnable) // set
ListView.accessibilityenable // get
```

**Setting Syntax**
```javascript
ListView 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.
...
**Syntax**
```javascript
ListView.set_accessibilitylabel(strLabel) // set
ListView.accessibilitylabel // get
```
...
**Syntax**
```javascript
ListView.set_accessibilityrole(enumRole) // set
ListView.accessibilityrole // get
```
...
**Syntax**
```javascript
ListView.set_autoenter(enumType) // set
ListView.autoenter // get
```
...
**Syntax**
```javascript
ListView.set_autoupdatetype(enumType) // set
ListView.autoupdatetype // get
```
...
**Syntax**
```javascript
ListView.set_background( strBackground ) // set 
ListView.background // get
```
...
**Syntax**
```javascript
ListView.set_bandexpandtype(enumExpandType) // set
ListView.bandexpandtype // get
```

**Setting Syntax**
```javascript
아이템 단위로 Detail 밴드를 팝업으로 표시합니다.
```
...
**Syntax**
```javascript
ListView.set_bandindentsize(nIndentSize) // set
ListView.bandindentsize // get
```

**Setting Syntax**
```javascript
Detail 밴드의 왼쪽 여백 너비를 픽셀 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_bandinitstatus(enumBandInit) // set
ListView.bandinitstatus // get
```

**Setting Syntax**
```javascript
ListView 가 최초 로드될 때 모든 아이템의 Detail 밴드를 표시하지 않습니다.
```
...
**Syntax**
```javascript
ListView.set_binddataset(strDatasetID) // set
ListView.binddataset // get
```
...
**Syntax**
```javascript
ListView.set_borderRadius(strborderradius) // set
ListView.borderRadius // get
```
...
**Syntax**
```javascript
ListView.set_bottom(nBottom) // set
ListView.bottom // get
```

**Setting Syntax**
```javascript
ListView 의 하단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 bottom 속성값을 기준으로 ListView 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 ListView 의 하단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 top 속성값을 기준으로 ListView 의 하단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 ListView 의 하단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
ListView.set_cellcalendarbuttonsize(strSize) // set
ListView.cellcalendarbuttonsize // get
```
...
**Syntax**
```javascript
ListView.set_cellcalendarpopupsize(strSize) // set
ListView.cellcalendarpopupsize // get
```
...
**Syntax**
```javascript
ListView.set_cellcalendarpopuptype(enumType) // set
ListView.cellcalendarpopuptype // get
```
...
**Syntax**
```javascript
ListView.set_cellcheckboxsize(nSize) // set
ListView.cellcheckboxsize // get
```
...
**Syntax**
```javascript
ListView.set_cellclickbound(enumBound) // set
ListView.cellclickbound // get
```

**Setting Syntax**
```javascript
CheckBox 이미지를 포함하여 Cell 영역 아무곳이나 클릭 시 데이터가 변경됩니다.
```
...
**Syntax**
```javascript
ListView.set_cellcombobuttonsize(strSize) // set
ListView.cellcombobuttonsize // get
```
...
**Syntax**
```javascript
ListView.set_cellcombopopupsize(strSize) // set
ListView.cellcombopopupsize // get
```
...
**Syntax**
```javascript
ListView.set_cellcombopopuptype(enumType) // set
ListView.cellcombopopuptype // get
```
...
**Syntax**
```javascript
ListView.set_cellmulticombobuttonsize(strSize) // set 
ListView.cellmulticombobuttonsize // get
```
...
**Syntax**
```javascript
ListView.set_cellmulticombopopupsize(strSize) // set 
ListView.cellmulticombopopupsize // get
```
...
**Syntax**
```javascript
ListView.set_cellmulticombopopuptype(enumType) // set 
ListView.cellmulticombopopuptype // get
```
...
**Syntax**
```javascript
ListView.set_color(strcolor) // set
ListView.color // get
```
...
**Syntax**
```javascript
ListView.set_createrowstype(enumType) // set 
ListView.createrowstype // get
```

**Setting Syntax**
```javascript
ListView 컴포넌트 생성 시점에 전체 Band를 생성합니다.
```
...
**Syntax**
```javascript
ListView.set_cssclass(strcssclass) // set
ListView.cssclass // get
```
...
**Syntax**
```javascript
ListView.set_cursor(strCursor) // set
ListView.cursor // get
```
...
**Syntax**
```javascript
ListView.set_enable(benable) // set
ListView.enable // get
```

**Setting Syntax**
```javascript
ListView 을(를) 사용할 수 없게 설정합니다.
...
**Syntax**
```javascript
ListView.set_enableevent(bEvent) // set
ListView.enableevent // get
```

**Setting Syntax**
```javascript
ListView 에서 이벤트가 발생하지 않도록 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_enableredraw(bRedraw) // set
ListView.enableredraw // get
```

**Setting Syntax**
```javascript
ListView 에 변경이 발생하여도 화면을 자동으로 다시 그리지 않습니다.
```
...
**Syntax**
```javascript
ListView.set_flexgrow(fVal) // set
ListView.flexgrow // get
```
...
**Syntax**
```javascript
ListView.set_flexshrink(fVal) // set
ListView.flexshrink // get
```
...
**Syntax**
```javascript
ListView.set_formatid(strFormatID) // set
ListView.formatid // get
```

**Setting Syntax**
```javascript
formats 속성에 정의된 포맷 중 ListView 에 표시할 포맷의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_formats(strFormat) // set
ListView.formats // get
```
...
**Syntax**
```javascript
ListView.set_height(nHeight) // set
ListView.height // get
```

**Setting Syntax**
```javascript
ListView 의 높이를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 ListView 의 높이가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 높이로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 ListView 의 높이가 결정됩니다.
```
...
**Syntax**
```javascript
ListView.set_initvalueid(strValueID) // set
ListView.initvalueid // get
```

**Setting Syntax**
```javascript
InitValueDefinition 영역에 정의된 InitValue 파일에서 ListView 에 적용할 항목의 ID 를 문자열로 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_layoutorder(nVal) // set
ListView.layoutorder // get
```
...
**Syntax**
```javascript
ListView.set_left(nLeft) // set
ListView.left // get
```

**Setting Syntax**
```javascript
ListView 의 좌측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 left 속성값을 기준으로 ListView 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 ListView 의 좌측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 right 속성값을 기준으로 ListView 의 좌측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 ListView 의 좌측 위치가 결정됩니다.
```
...
**Syntax**
```javascript
ListView.set_letterSpacing(strspace) // set
ListView.letterSpacing // get
```
...
**Syntax**
```javascript
ListView.set_locale(strlocale) // set
ListView.locale // get
```
...
**Syntax**
```javascript
ListView.set_maxheight(nMaxHeight) // set
ListView.maxheight // get
```

**Setting Syntax**
```javascript
ListView 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_maxwidth(nMaxWidth) // set
ListView.maxwidth // get
```

**Setting Syntax**
```javascript
ListView 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_minheight(nMinHeight) // set
ListView.minheight // get
```

**Setting Syntax**
```javascript
ListView 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_minwidth(nMinWidth) // set
ListView.minwidth // get
```

**Setting Syntax**
```javascript
ListView 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_nodataimage(strUrl) // set
ListView.nodataimage // get
```
...
**Syntax**
```javascript
ListView.set_nodatatext(strText) // set
ListView.nodatatext // get
```

**Setting Syntax**
```javascript
ListView 에 표시할 데이터가 없을 때 출력할 텍스트를 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_opacity(strOpacity) // set
ListView.opacity // get
```
...
**Syntax**
```javascript
ListView.set_positionstep(nStep) // set
ListView.positionstep // get
```

**Setting Syntax**
```javascript
ListView 이(가) 표시될 분할화면의 인덱스를 설정합니다.
...
**Syntax**
```javascript
ListView.set_readonly(bReadOnly) // set
ListView.readonly // get
```

**Setting Syntax**
```javascript
ListView 의 편집을 가능하게 설정합니다.
```
...
**Syntax**
```javascript
ListView.set_right(nRight) // set
ListView.right // get
```

**Setting Syntax**
```javascript
ListView 의 우측 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 right 속성값을 기준으로 ListView 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 ListView 의 우측 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 left 속성값을 기준으로 ListView 의 우측 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 ListView 의 우측 위치가 결정됩니다.
```
...
**Setting Syntax**
```javascript
ListView 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
...
**Syntax**
```javascript
ListView.set_scrollbarbarminsize( nSize ) // set 
ListView.scrollbarbarminsize // get
```
...
**Syntax**
```javascript
ListView.set_scrollbarbaroutsize( nSize ) // set 
ListView.scrollbarbaroutsize // get
```
...
**Syntax**
```javascript
ListView.set_scrollbardecbuttonsize(nSize) // set
ListView.scrollbardecbuttonsize // get
```
...
**Syntax**
```javascript
ListView.set_scrollbarincbuttonsize(nSize) // set
ListView.scrollbarincbuttonsize // get
```
...
**Syntax**
```javascript
ListView.set_scrollbarsize(nSize) // set
ListView.scrollbarsize // get
```
...
**Syntax**
```javascript
ListView.set_scrollbartrackbarsize( nSize ) // set 
ListView.scrollbartrackbarsize // get
```
...
**Syntax**
```javascript
ListView.set_scrollbartype(strBartype) // set
ListView.scrollbartype // get
```
...
- 데스크탑에 적용되는 값과 모바일에 적용되는 값을 함께 설정할 수 있지만 권장하지 않습니다.
   ex) set_scrollbartype( "fixed autoindicator" ) ;
...
**Syntax**
```javascript
ListView.set_scrollindicatorsize(nSize) // set
ListView.scrollindicatorsize // get
```
...
**Syntax**
```javascript
ListView.set_scrolltype(enumType) // set
ListView.scrolltype // get
```

**Setting Syntax**
```javascript
ListView 에서 수평 스크롤만 사용합니다.
...
**Syntax**
```javascript
ListView.set_selectchangetype(enumChangetype) // set
ListView.selectchangetype // get
```

**Setting Syntax**
```javascript
ListView 에 마우스 왼쪽버튼으로 Down&Up 했을 때 선택이 결정됩니다.
...
**Syntax**
```javascript
ListView.set_selectscrollmode( enumMode ) // set
ListView.selectscrollmode                           // get
```
...
**Syntax**
```javascript
ListView.set_tablecellarea(strArea) // set
ListView.tablecellarea // get
```
...
**Syntax**
```javascript
ListView.set_taborder(nTabOrder) // set
ListView.taborder // get
```
...
**Syntax**
```javascript
ListView.set_tabstop(bTabStop) // set
ListView.tabstop // get
```

**Setting Syntax**
```javascript
ListView 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
```
...
**Syntax**
```javascript
ListView.set_tooltiptext(strToolTipText) // set
ListView.tooltiptext // get
```
...
**Syntax**
```javascript
ListView.set_tooltiptype(enumTooltipType) // set
ListView.tooltiptype // get
```

**Setting Syntax**
```javascript
ListView 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
**Syntax**
```javascript
ListView.set_top(nTop) // set
ListView.top // get
```

**Setting Syntax**
```javascript
ListView 의 상단 좌표값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 부모(Parent)의 top 속성값을 기준으로 ListView 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 height 속성값을 기준으로 ListView 의 상단 위치가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 의 bottom 속성값을 기준으로 ListView 의 상단 위치가 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 height 속성값을 기준으로 ListView 의 상단 위치가 결정됩니다.
```
...
**Syntax**
```javascript
ListView.set_useselcolor(bUsecolor) // set
ListView.useselcolor // get
```

**Setting Syntax**
```javascript
선택된 아이템에 Select 관련 Status 를 적용시키지 않습니다.
```
...
**Syntax**
```javascript
ListView.set_usesoftkeyboard(bUseKeyboard) // set
ListView.usesoftkeyboard // get
```

**Setting Syntax**
```javascript
ListView 의 Cell 에 편집모드용 컨트롤이 표시되어 포커스를 가져도 키패드가 표시되지 않습니다.
```
...
**Syntax**
```javascript
ListView.set_visible(bVisible) // set
ListView.visible // get
```

**Setting Syntax**
```javascript
ListView 을(를) 화면에 표시하지 않습니다.
```
...
**Setting Syntax**
```javascript
this.ListView00.vscrollbar.set_decbuttonsize( 30 );
```
...
**Syntax**
```javascript
ListView.set_width(nWidth) // set
ListView.width // get
```

**Setting Syntax**
```javascript
ListView 의 너비를 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
pixel 단위로 설정 시 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 부모(Parent)의 width 속성값을 기준으로 ListView 의 너비가 결정됩니다.

* <strCompID> 값을 설정했을 때 :
pixel 단위로 설정 시 <strCompID> 값은 무시되고 설정값이 너비로 결정됩니다.
비율("%") 단위로 설정 시 <strCompID> 의 width 속성값을 기준으로 ListView 의 너비가 결정됩니다.
```
...
**Syntax**
```javascript
ListView.set_wordSpacing(strWordSpacing) // set
ListView.wordSpacing // get
```
