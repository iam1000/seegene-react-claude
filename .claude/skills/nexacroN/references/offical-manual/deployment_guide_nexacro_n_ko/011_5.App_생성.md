---
title: "5.App 생성"
source: "https://docs.tobesoft.com/deployment_guide_nexacro_n_ko/d27b8a592ee934cd"
crawled_at: "2026-01-09T10:58:11.861Z"
---

# 5.App 생성

Nexacro N / 모든 매뉴얼에서 검색앱 배포 가이드App Builder (Android, iOS, macOS)5.App 생성article

# 5.App 생성

## [Download PDF](https://docs.tobesoft.com/r/pdf/download_chapter/96178378e13939b8/d27b8a592ee934cd)
...
5.1.2Nexacro Library

5.1.3Target OS

5.2추가 옵션 설정하기

5.2.1Basic Property Options

5.2.2Target OS > Android Options

Device API 권한 추가

5.2.3Target OS > iOS Options

5.2.4Target OS > macOS Options

5.2.5Target OS > Icon Generate를 사용해 이미지 파일 생성하기

5.2.6Target OS > 프로젝트 파일 내보내고 가져오기

5.2.7Target OS > User Library
...
![](https://docs.tobesoft.com/r/book_image/get/9c3a103db1a5d2dd?0)

# 5.1앱 기본 설정값 입력하기

정보를 입력하고 \[Save\] 또는 \[Build\] 버튼을 클릭하기 전에는 "App"이 생성되지 않습니다.

![](https://docs.tobesoft.com/r/book_image/get/d4e5a2748d91361f?0)
...
![](https://docs.tobesoft.com/r/book_image/get/802a7342b8a9e78b?0)
...
![](https://docs.tobesoft.com/r/book_image/get/39e4a3e5360a9d3f?0)
...
![](https://docs.tobesoft.com/r/book_image/get/04aa0fdae3296d4f?0)
...
![](https://docs.tobesoft.com/r/book_image/get/3d763c7679dcb52f?0)
...
![](https://docs.tobesoft.com/r/book_image/get/1b9dc13ee4d7aae3?0)

\[Upload Histroy\] 버튼을 클릭하면 리소스 파일 등을 업로드한 이력을 확인할 수 있습니다.

![](https://docs.tobesoft.com/r/book_image/get/0dbd1738d6f4f031?0)
...
![](https://docs.tobesoft.com/r/book_image/get/5538d73040c312b9?0)

# 5.2추가 옵션 설정하기

기본 설정값만 입력하면 앱 빌드 작업까지 진행할 수 있습니다. 각 항목별로 추가적인 옵션을 설정하려면 항목 오른쪽 아래에 있는 \[Option +\] 버튼을 클릭하고 옵션 항목을 펼친 후에 설정할 수 있습니다.

![](https://docs.tobesoft.com/r/book_image/get/23d17e825f47e2b3?0)

## 5.2.1Basic Property Options

![](https://docs.tobesoft.com/r/book_image/get/a6b13f139177a113?0)
...
![](https://docs.tobesoft.com/r/book_image/get/923969d3d831ebb5?0)
...
![](https://docs.tobesoft.com/r/book_image/get/560852bffdce099d?0)
...
![](https://docs.tobesoft.com/r/book_image/get/6ebf7f71204e95d9?0)

Map, X-PUSH를 사용하는 경우에는 추가로 키값을 입력해주어야 합니다. X-PUSH 권한 지정 시에는 Firebase Android 구성 파일(google-services.json)을 첨부해주어야 합니다.

![](https://docs.tobesoft.com/r/book_image/get/2b03c094e37e4a67?0)

## 5.2.3Target OS > iOS Options

![](https://docs.tobesoft.com/r/book_image/get/a7525005548afbdd?0)
...
![](https://docs.tobesoft.com/r/book_image/get/7240d04aaf6e8ecf?0)
...
![](https://docs.tobesoft.com/r/book_image/get/90d1d0c6cbbadf83?0)
...
![](https://docs.tobesoft.com/r/book_image/get/a82dd44657544886?0)
...
![](https://docs.tobesoft.com/r/book_image/get/4d162ec1d0dc1c8a?0)
...
![](https://docs.tobesoft.com/r/book_image/get/4e185584974f6be8?0)
...
![](https://docs.tobesoft.com/r/book_image/get/c22fffa6a31a8284?0)

새로 라이브러리를 추가해야 한다면 \[New\] 버튼을 클릭해서 새로운 항목을 등록할 수 있습니다.

![](https://docs.tobesoft.com/r/book_image/get/e9adf53ae9c82fa4?0)
...
![](https://docs.tobesoft.com/r/book_image/get/d3863de52b100424?0)
