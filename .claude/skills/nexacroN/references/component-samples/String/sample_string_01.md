...
| TextArea00 | TextArea | - |
| TextArea01 | TextArea | - |
| Static00 | Static | text="English" |
| Static01 | Static | text="Korean" |
...
// source: http://www.theyt.net/wiki/%ED%95%9C%EC%98%81%ED%83%80%EB%B3%80%ED%99%98%EA%B8%B0
...
this.engTypeToKor = function (src){
	var res = "";
	if (src.length == 0)
	return res;
...
this.korTypeToEng = function(src) {
	var res = "";
	if (src.length == 0)
	return res;
